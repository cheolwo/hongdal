...
/// <summary>주문자 앱 세션의 복원·로그인·로그아웃 표시 상태만 관리합니다.</summary>
public sealed partial class 주문자음식주문인증ViewModel(
...
public sealed class 주문자음식주문PageViewModel : 조립ViewModelBase
{
    public 주문자음식주문PageViewModel(
        ...
        주문자음식주문인증ViewModel authentication,
    ...
    public 주문자음식주문인증ViewModel 인증 { get; }
