...
public sealed class 주문자하차ViewModel(I하차관점Service service, ISsalddel현재사용자Context context)
...
public sealed class 판매자하차ViewModel(I하차관점Service service, ISsalddel현재사용자Context context)
...
public sealed class 창고관리자하차ViewModel(I하차관점Service service, ISsalddel현재사용자Context context)
...
public sealed class 운송담당자하차ViewModel(I하차관점Service service, ISsalddel현재사용자Context context)
...
public sealed class 협동조합운영자하차ViewModel(I하차관점Service service, ISsalddel현재사용자Context context)
