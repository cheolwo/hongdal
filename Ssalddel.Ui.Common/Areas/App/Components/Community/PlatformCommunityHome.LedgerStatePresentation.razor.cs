...
public partial class PlatformCommunityHome
{
    ...
    private static string? 현재원장활성노드제목해결(string templateKey, string stateLabel)
    {
        ...
        if (templateKey is CommunityLedgerTemplateKeys.SsalddelMart)
        {
            return ResolveSsalddelMartActiveNodeTitle(stateLabel);
        }
    ...
    private static string? ResolveSsalddelMartActiveNodeTitle(string stateLabel)
    {
