...
public sealed class SsalddelIsmsPClientEncryptionService : IAsyncDisposable
{
    private readonly IJSRuntime jsRuntime;
    private IJSObjectReference? module;

    public SsalddelIsmsPClientEncryptionService(IJSRuntime jsRuntime)
    {
        ...
        string? associatedData = null)
    {
        ...
        module ??= await jsRuntime.InvokeAsync<IJSObjectReference>(
            "import",
            "./_content/Ssalddel.Ui.Common/Areas/App/js/ssalddel-isms-p-transport.js");
