...
internal static class GroupPurchaseUiModule
{
    internal static IServiceCollection AddGroupPurchaseUiModule(this IServiceCollection services)
    {
        ...
        services.TryAddScoped<I같이수입원장전환Client, 같이수입원장전환Client>();
        services.TryAddScoped<I같이수입준비주문자Client, 같이수입준비주문자Client>();
        services.TryAddScoped<I무역확장원장Client, 무역확장원장Client>();
        services.TryAddScoped<I같이수입선적통관Client, 같이수입선적통관Client>();
        ...
        services.TryAddScoped<같이수입전환준비ViewModel>();
        ...
        services.TryAddScoped<같이수입원장물류ViewModel>();
        services.TryAddScoped<같이수입선적통관ViewModel>();
        services.TryAddScoped<같이수입원장조회ViewModel>();
        services.TryAddScoped<개별수입원장생성ViewModel>();
        services.TryAddScoped<개별수출원장생성ViewModel>();
        services.TryAddScoped<공동수출원장생성ViewModel>();
        services.TryAddScoped<같이수입원장미리보기ViewModel>();
        services.TryAddScoped<같이수입원장전환ViewModel>();
        services.TryAddScoped<같이수입선적공개조회ViewModel>();
        services.TryAddScoped<같이수입선적관리목록조회ViewModel>();
        services.TryAddScoped<같이수입선적등록ViewModel>();
        services.TryAddScoped<같이수입선적이벤트등록ViewModel>();
        services.TryAddScoped<같이수입통관동기화ViewModel>();
        services.TryAddTransient<같이수입분기ViewModel>();
