...
public sealed class PlatformCommunityDecorationStateService
{
    ...
    public const string DefaultHomeThemePackKey = "home-theme-ssalddel-default-v1";
    ...
    private static List<CommunityDecorationProduct> BuildProducts()
    {
        ...
        {
            new(
                "store-home-theme-ssalddel-default-v1",
            ...
            new(
                ...
                0,
                "KRW",
                [new(BasicBaguaAssetKey, "bagua-basic", "푸른 감괘", "Ssalddel", "기본 후천 사방 표시", CommunityDecorationTarget.Bagua, "☵", "#2563eb")]),
            new(
                ...
                0,
                "KRW",
                [new("bagua-wonbanggak", "bagua-wonbanggak", "원방각", "Ssalddel Community", "원방각 커뮤니티 표시", CommunityDecorationTarget.Bagua, "○□△", "#ec4899")]),
            new(
                "store-bagua-night",
                "bagua-night",
                "별빛 사방판",
