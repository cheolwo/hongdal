...
namespace Ssalddel.Application.ViewSettings;
...
[SsalddelUseCase("사용자 View 설정", Summary = "사용자가 역할과 앱에 맞는 화면 노출 상태를 조회하고 개인별 화면 설정을 저장합니다.")]
...
public sealed class View설정UseCase : IView설정UseCase
{
    ...
    private static Result<string> 역할명해결(string appKey, string? requestedRoleName)
    {
        ...
        return appKey switch
        {
            ...
            App식별자.SsalddelApp => 역할명.화주,
            App식별자.SsalddelAdmin => 역할명.서버관리자,
