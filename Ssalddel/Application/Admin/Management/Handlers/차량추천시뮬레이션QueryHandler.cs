...
public sealed class 차량추천시뮬레이션QueryHandler : IRequestHandler<차량추천시뮬레이션Query, Ssalddel.Contracts.Admin.Management.차량추천시뮬레이션응답>
{
    ...
    public async Task<Ssalddel.Contracts.Admin.Management.차량추천시뮬레이션응답> Handle(차량추천시뮬레이션Query request, CancellationToken cancellationToken)
    {
