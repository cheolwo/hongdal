...
namespace Ssalddel.Application.Audit;
...
[SsalddelUseCase("사용자 행위 로그 조회", Summary = "운영자가 사용자 행위 로그를 조회하고 커뮤니티 활동 신호의 원천 기록을 확인합니다.")]
...
public sealed class 사용자행위로그조회UseCase : I사용자행위로그조회UseCase
{
    ...
    public 사용자행위로그조회UseCase(SsalddelContext db)
    {
        _db = db;
    }
