...
public sealed class 내친구수신함조회QueryHandler : IRequestHandler<내친구수신함조회Query, IReadOnlyList<친구요청항목응답>>
{
    private readonly SsalddelContext _db;
    private readonly ICurrentUserAccessor _currentUserAccessor;

    public 내친구수신함조회QueryHandler(SsalddelContext db, ICurrentUserAccessor currentUserAccessor)
    {
        _db = db;
        _currentUserAccessor = currentUserAccessor;
    }

    public async Task<IReadOnlyList<친구요청항목응답>> Handle(내친구수신함조회Query request, CancellationToken cancellationToken)
    {
