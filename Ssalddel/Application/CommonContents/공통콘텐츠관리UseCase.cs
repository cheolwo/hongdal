...
public sealed class 공통콘텐츠관리UseCase : I공통콘텐츠관리UseCase
{
    ...
    public 공통콘텐츠관리UseCase(SsalddelContext db)
    {
        _db = db;
    }
    ...
    public async Task<Result<IReadOnlyList<관리자공통콘텐츠요약응답>>> 목록조회Async(CancellationToken cancellationToken)
    {
        var items = await _db.살뜰공통콘텐츠
            ...
            .Select(x => new 관리자공통콘텐츠요약응답
            {
                Id = x.Id,
                제목 = x.제목,
                콘텐츠유형 = (계약살뜰콘텐츠유형)x.콘텐츠유형,
                노출위치 = (계약살뜰노출위치)x.노출위치,
                활성화여부 = x.활성화여부,
                생성시각 = x.생성시각
            })
        ...
        CancellationToken cancellationToken)
    {
        ...
        var entity = new 살뜰공통콘텐츠();
        Apply(entity, request);

        _db.살뜰공통콘텐츠.Add(entity);
        await _db.SaveChangesAsync(cancellationToken);

        var saved = await _db.살뜰공통콘텐츠
            .AsNoTracking()
            .Include(x => x.보상정책)
        ...
        CancellationToken cancellationToken)
    {
        ...
        var entity = await _db.살뜰공통콘텐츠.FirstOrDefaultAsync(x => x.Id == id, cancellationToken);
        if (entity is null)
        {
    ...
    {
        var items = await _db.살뜰콘텐츠보상정책
            .AsNoTracking()
            .OrderByDescending(x => x.Id)
            .Select(x => new 공통콘텐츠보상정책Dto
            {
                Id = x.Id,
                보상유형 = (계약살뜰보상유형)x.보상유형,
                지급포인트 = x.지급포인트,
                할인율 = x.할인율,
                할인금액 = x.할인금액,
                최소시청초 = x.최소시청초,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var policy = new 살뜰콘텐츠보상정책
        {
            보상유형 = (살뜰보상유형)request.보상유형,
            지급포인트 = request.지급포인트,
            할인율 = request.할인율,
            할인금액 = request.할인금액,
            최소시청초 = request.최소시청초,
    ...
    private static 관리자공통콘텐츠상세응답 ToDetail(살뜰공통콘텐츠 entity)
    {
        return new 관리자공통콘텐츠상세응답
        {
            ...
            제목 = entity.제목,
            설명 = entity.설명,
            콘텐츠유형 = (계약살뜰콘텐츠유형)entity.콘텐츠유형,
            이미지Url = entity.이미지Url,
            영상Url = entity.영상Url,
            외부링크Url = entity.외부링크Url,
            노출위치 = (계약살뜰노출위치)entity.노출위치,
            기사노출 = entity.기사노출,
            화주노출 = entity.화주노출,
            운영자노출 = entity.운영자노출,
            활성화여부 = entity.활성화여부,
            ...
            보상정책 = entity.보상정책 is null
                ...
                {
                    Id = entity.보상정책.Id,
                    보상유형 = (계약살뜰보상유형)entity.보상정책.보상유형,
