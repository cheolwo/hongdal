...
public interface I같이수입HS코드조회UseCase
{
...
[SsalddelUseCase("같이 수입 HS 코드 조회", Summary = "주문자가 같이 수입 상품 후보를 고를 수 있도록 활성 HS 코드와 통관 주의 태그를 조회합니다.")]
[SsalddelUseCaseActor(SsalddelActor.Orderer)]
public sealed class 같이수입HS코드조회UseCase : I같이수입HS코드조회UseCase
{
