...
[SsalddelUseCase("HS 코드 운영", Summary = "운영자와 관세사가 HS 코드 업무 분류와 통관 주의 태그를 조회하고 보정합니다.")]
[SsalddelUseCaseActor(SsalddelActor.CustomsBroker)]
...
public sealed class HS코드운영UseCase : IHS코드운영UseCase
{
    ...
    public HS코드운영UseCase(SsalddelContext db, I사용자행위로그Service activityLogService)
    {
        _db = db;
