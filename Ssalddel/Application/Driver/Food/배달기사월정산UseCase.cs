...
[SsalddelUseCase("배달 기사 월정산", Summary = "배달 기사가 당월 정산과 이용료 결제 완료 상태를 조회하고 확인합니다.")]
[SsalddelUseCaseActor(SsalddelActor.FoodDeliveryDriver)]
...
public sealed class 배달기사월정산UseCase : I배달기사월정산UseCase
{
    ...
    public 배달기사월정산UseCase(SsalddelContext db, I기사월정산Service driverMonthlySettlementService)
    {
        _db = db;
    ...
    private static 배달기사월정산응답 응답변환(살뜰.도메인.기사.기사월정산 settlement)
    {
