...
[SsalddelUseCase("공동구매 해외 선적 추적", Summary = "문서관리번호와 BL 기반으로 공동구매 수입 화물 위치, 통관, 보세구역 정규화 정보를 조회하고 원장을 관리합니다.")]
[SsalddelUseCaseActor(SsalddelActor.Orderer)]
[SsalddelUseCaseActor(SsalddelActor.OverseasSellerOrForwarder, SsalddelUseCaseActorRole.Supporting)]
