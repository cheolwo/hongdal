...
현재 제품 집중 버전은 **`0.0 커뮤니티·공공데이터 기반`**입니다. 공개 음식·재료 정보, 게시글·대화, 참여 동의, 공동 원장과 완료 사례의 폐쇄 루프를 후속 업무 module 없이 독립적으로 안정화합니다.

공동구매 수요·집단화는 `1.0`, 공급·가격·HS·수입 준비는 `1.5`, 실제 운송 의뢰·배차·증빙은 `2.0`, 입고·재고·판매·최종 배분은 `2.5` 후속 자산으로 보존하며 기본 Feature를 끕니다.
