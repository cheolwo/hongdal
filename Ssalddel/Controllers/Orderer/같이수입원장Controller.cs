...
public sealed class 같이수입원장Controller : OrdererControllerBase
{
    private readonly I같이수입원장전환Service _원장전환Service;

    public 같이수입원장Controller(I같이수입원장전환Service 원장전환Service)
    {
