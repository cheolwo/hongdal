...
[SsalddelApiContractName("CommunityAuthoringImagesController")]
public sealed class 커뮤니티작성이미지Controller : ControllerBase
{
    ...
    [SsalddelApiContractName("Plan")]
    public ActionResult<CommunityAuthoringImagePromptPlanResponse> 생성계획수립(
    ...
    [HttpPost]
    [SsalddelApiContractName("Generate")]
    public async Task<ActionResult<CommunityAuthoringImageTaskResponse>> 생성(
    ...
    public async Task<ActionResult<CommunityAuthoringImageTaskResponse>> 조회(
        string jobCode,
    ...
    [SsalddelApiContractName("Attach")]
    public async Task<IActionResult> 게시글첨부(
        string jobCode,
        long postId,
