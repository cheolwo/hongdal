...
[SsalddelCodeMetadata(
    ...
    "관리자가 1.0 Process Manager 내부·공유 배치의 등록 상태, 일정, 선행 작업, 출처와 실행 경계를 읽습니다.",
...
public sealed class 공동구매수요모집BatchCatalogAdminController : ControllerBase
{
    private readonly I공동구매수요모집BatchCatalog _catalog;

    public 공동구매수요모집BatchCatalogAdminController(
        I공동구매수요모집BatchCatalog catalog)
    {
        _catalog = catalog;
    }
