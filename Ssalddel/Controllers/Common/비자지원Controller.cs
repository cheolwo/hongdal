...
using FluentResults;
using Ssalddel.Application.Immigration;
...
[SsalddelApiContractName("VisaSupportController")]
public sealed class 비자지원Controller : ControllerBase
{
    private readonly ISender _sender;

    public 비자지원Controller(ISender sender)
    {
        _sender = sender;
    }

    [HttpPost]
    [SsalddelApiContractName("RequestVisaSupport")]
    public async Task<IActionResult> 비자지원요청([FromBody] VisaSupportRequest request, CancellationToken cancellationToken)
    {
