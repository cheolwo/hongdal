...
[SsalddelApiContractName("CommunityPostOpportunitiesController")]
public sealed class 커뮤니티게시글참여기회Controller : CommunityControllerBase
{
    ...
    public async Task<ActionResult<CommunityPostOpportunityListResponse>> 기회목록조회(
        long postId,
    ...
    [AllowAnonymous]
    [SsalddelApiContractName("GetContextDiscovery")]
    public async Task<ActionResult<CommunityPostContextDiscoveryResponse>> 문맥탐색조회(
        long postId,
    ...
    [Authorize]
    [SsalddelApiContractName("StartMeatImportReadiness")]
    public async Task<ActionResult<StartCommunityMeatImportReadinessResponse>> 육류수입준비시작(
        long postId,
    ...
    [Authorize]
    [SsalddelApiContractName("StartParticipation")]
    public async Task<ActionResult<StartCommunityPostParticipationResponse>> 참여시작(
        long postId,
    ...
    [Authorize]
    [SsalddelApiContractName("PromoteParticipation")]
    public async Task<ActionResult<PromoteCommunityPostParticipationResponse>> 참여승격(
        long postId,
    ...
    [Authorize]
    [SsalddelApiContractName("JoinProfessional")]
    public async Task<ActionResult<JoinCommunityPostProfessionalResponse>> 전문가참여(
        long postId,
    ...
    [Authorize]
    [SsalddelApiContractName("JoinPartyRole")]
    public async Task<ActionResult<JoinCommunityPostPartyRoleResponse>> 당사자역할참여(
        long postId,
