...
[SsalddelApiVersion(SsalddelProductVersion.V0_5)]
[SsalddelApiWorkflow(SsalddelWorkflow.CommunityTrust)]
[SsalddelApiGrowthTrack(SsalddelApiGrowthTrack.Community)]
[ApiController]
[Authorize]
[Route("api/v1/order-perspectives/individual-orders")]
[SsalddelApiContractName("IndividualOrderPerspectiveReadController")]
public sealed class 개별주문관점조회Controller(
    IIndividualOrderPerspectiveReadService 개별주문관점조회Service) : CommunityControllerBase
{
    [HttpGet("orderer")]
    ...
    private async Task<IActionResult> Query(
        ...
        CancellationToken cancellationToken)
        => this.ToActionResult(await 개별주문관점조회Service.QueryAsync(
            perspective,
            communityLedgerId,
            request,
            cancellationToken));
