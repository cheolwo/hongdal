...
namespace 살뜰.Services.ViewSettings;
...
public static class View카탈로그
{
    ...
    [
        ...
        new(App식별자.SsalddelApp, View식별자.Shipper.Home, "Home", "/", Icons.Common.Home, 역할명.화주, true, true, 10),
        new(App식별자.SsalddelApp, View식별자.Shipper.TransportWorkspace, "운송 업무", "/shipper/transport", Icons.Shipper.TransportWorkspace, 역할명.화주, true, true, 15),
        new(App식별자.SsalddelApp, View식별자.Shipper.Request, "화물운송의뢰 등록", "/shipper/request", Icons.Shipper.Request, 역할명.화주, true, true, 20),
        new(App식별자.SsalddelApp, View식별자.Shipper.PublicCargo, "공개 화물정보", "/shipper/public-cargo", Icons.Shipper.PublicCargo, 역할명.화주, false, true, 30),
        new(App식별자.SsalddelApp, View식별자.Shipper.ExplorationInbox, "받은 탐색 문의함", "/shipper/exploration/inbox", Icons.Shipper.ExplorationInbox, 역할명.화주, false, true, 40),
        new(App식별자.SsalddelApp, View식별자.Shipper.WarehouseWorkspace, "창고 작업대", "/shipper/warehouse/workspace", Icons.Shipper.WarehouseWorkspace, 역할명.화주, false, true, 50),
        new(App식별자.SsalddelApp, View식별자.Shipper.InboundDashboard, "입고 대시보드", "/shipper/inbound/dashboard", Icons.Shipper.InboundDashboard, 역할명.화주, false, true, 60),
        new(App식별자.SsalddelApp, View식별자.Shipper.InboundRequests, "입고 현황", "/shipper/inbound/requests", Icons.Shipper.InboundRequests, 역할명.화주, false, true, 70),
        new(App식별자.SsalddelApp, View식별자.Shipper.WarehouseInventory, "재고 목록", "/shipper/warehouse/inventory", Icons.Shipper.WarehouseInventory, 역할명.화주, false, true, 80),
        ...
        new(App식별자.SsalddelAdmin, View식별자.Admin.Home, "홈", "/", Icons.Common.Home, 역할명.서버관리자, true, true, 10),
        new(App식별자.SsalddelAdmin, View식별자.Admin.Dashboard, "01. 업무 안내판", "/dashboard", Icons.Admin.Dashboard, 역할명.서버관리자, true, true, 20),
        new(App식별자.SsalddelAdmin, View식별자.Admin.DispatchWait, "02. 유입/배차대기", "/dispatch/wait", Icons.Admin.DispatchWait, 역할명.서버관리자, true, true, 30),
        new(App식별자.SsalddelAdmin, View식별자.Admin.ExplorationCampaigns, "03. 탐색 캠페인", "/exploration/campaigns", Icons.Admin.ExplorationCampaigns, 역할명.서버관리자, false, true, 40),
        new(App식별자.SsalddelAdmin, View식별자.Admin.Requests, "04. 의뢰 관리", "/requests", Icons.Admin.Requests, 역할명.서버관리자, true, true, 50),
        new(App식별자.SsalddelAdmin, View식별자.Admin.Payments, "05. 결제 관리", "/payments", Icons.Admin.Payments, 역할명.서버관리자, false, true, 60),
        new(App식별자.SsalddelAdmin, View식별자.Admin.Transports, "06. 운송 진행", "/transports", Icons.Admin.Transports, 역할명.서버관리자, false, true, 70),
        new(App식별자.SsalddelAdmin, View식별자.Admin.DriverOperating, "07. 기사 운행현황", "/drivers/operating", Icons.Admin.DriverOperating, 역할명.서버관리자, false, true, 80),
        new(App식별자.SsalddelAdmin, View식별자.Admin.FilesPod, "08. 파일/POD", "/files/pod", Icons.Admin.FilesPod, 역할명.서버관리자, false, true, 90),
        new(App식별자.SsalddelAdmin, View식별자.Admin.Settlements, "09. 정산 관리", "/settlements", Icons.Admin.Settlements, 역할명.서버관리자, false, true, 100),
        new(App식별자.SsalddelAdmin, View식별자.Admin.Drivers, "10. 기사 관리", "/drivers", Icons.Admin.Drivers, 역할명.서버관리자, false, true, 110),
        new(App식별자.SsalddelAdmin, View식별자.Admin.Partners, "11. 업체/화주 관리", "/partners", Icons.Admin.Partners, 역할명.서버관리자, false, true, 120),
        new(App식별자.SsalddelAdmin, View식별자.Admin.PublicCargo, "12. 공개 화물정보", "/cargo", Icons.Admin.PublicCargo, 역할명.서버관리자, false, true, 130),
        new(App식별자.SsalddelAdmin, View식별자.Admin.VehicleManagement, "13. 차량 추천/단가 관리", "/vehicle-management", Icons.Admin.VehicleManagement, 역할명.서버관리자, false, true, 140),
        new(App식별자.SsalddelAdmin, View식별자.Admin.Documents, "14. 문서 관리", "/documents", Icons.Admin.Documents, 역할명.서버관리자, false, true, 150),
        new(App식별자.SsalddelAdmin, View식별자.Admin.ViewPolicies, "15. 화면 정책", "/view-policies", Icons.Common.Settings, 역할명.서버관리자, true, true, 160),
        new(App식별자.SsalddelAdmin, View식별자.Admin.ActivityLogs, "16. 사용자 행위 로그", "/activity-logs", Icons.Admin.ActivityLogs, 역할명.서버관리자, true, true, 170),
        new(App식별자.SsalddelAdmin, View식별자.Admin.FoodOperations, "17. 음식 운영", "/food/operations", Icons.Admin.FoodOperations, 역할명.서버관리자, false, true, 180),
        new(App식별자.SsalddelAdmin, View식별자.Admin.HsCodeOperations, "18. HS 코드 운영", "/customs/hs-codes", Icons.Admin.HsCodeOperations, 역할명.서버관리자, false, true, 190),

        new(App식별자.SsalddelAdmin, View식별자.CustomsBroker.HsCodeOperations, "HS 코드 보정", "/customs/hs-codes", Icons.Admin.HsCodeOperations, 역할명.관세사, true, true, 10)
    ];
    ...
    public static class Icons
    {
        ...
        public static class Shipper
        {
            ...
            public const string WarehouseWorkspace = "warehouse";
            ...
            public const string OrderFulfillment = "outbox";
            public const string CustomsHsReviews = "fact_check";
        }
        ...
        public static class Admin
        {
            ...
            public const string HsCodeOperations = "bi bi-tags";
        }
    }
}
