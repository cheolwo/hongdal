...
public sealed class CommunityPrajnaPostSource : ICommunityAutomatedPostSource
{
    ...
    public CommunityPrajnaPostSource(SsalddelContext db)
    {
        _db = db;
    }
        ...
        DateOnly publicationDate)
    {
        ...
        body.Add("홍익학당은 현재 살뜰의 협력기관이 아닙니다. 이 글은 제휴나 공식 추천을 뜻하지 않으며 원문은 출처 링크에서 확인해 주세요.");
        ...
        TimeZoneInfo timeZone)
    {
        ...
        body.Add($"{channelName}은(는) 현재 살뜰의 협력기관으로 표시되지 않습니다. 이 글은 제휴·교리의 우열·공식 추천을 뜻하지 않으며 영상 내용과 권리는 원 출처에 있습니다.");
