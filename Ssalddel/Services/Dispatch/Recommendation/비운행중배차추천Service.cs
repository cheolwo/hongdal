namespace 살뜰.Services.Dispatch.Recommendation
{
    ...
    {
        Task<IReadOnlyList<Ssalddel.Hubs.DispatchRecommendationDto>> GetRecommendationsAsync(string driverId, 배차추천검색조건? criteria = null);
    }
    ...
    public sealed class 비운행중배차추천Service : I비운행중배차추천Service
    {
        ...
        public Task<IReadOnlyList<Ssalddel.Hubs.DispatchRecommendationDto>> GetRecommendationsAsync(string driverId, 배차추천검색조건? criteria = null)
        {
