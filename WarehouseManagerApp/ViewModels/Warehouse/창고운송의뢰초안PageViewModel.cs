...
/// <summary>운송의뢰 로컬 초안 페이지의 기능 노출과 창고 업무 인증만 관리합니다.</summary>
public sealed class 창고운송의뢰초안PageViewModel : 창고PageViewModelBase
{
    ...
    private string _기능안내 = "운송의뢰 초안 기능 상태를 확인하고 있습니다.";
    ...
    public 창고운송의뢰초안PageViewModel(창고작업세션상태ViewModel 세션, 창고로그인ViewModel 인증, WarehousePageAvailabilityService availability)
        : base(세션, 창고PageCodes.일반운송의뢰초안, "운송의뢰 로컬 초안", 창고운영ProfileCodes.일반입출고)
    {
    ...
    public async Task<bool> 초기화Async(CancellationToken cancellationToken = default)
    {
        ...
        catch(Exception) when(!cancellationToken.IsCancellationRequested){기능사용가능=false;페이지오류메시지="운송의뢰 초안 기능 응답을 처리하지 못했습니다.";}
