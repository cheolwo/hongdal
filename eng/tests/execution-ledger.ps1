...
$first = & powershell -NoProfile -ExecutionPolicy Bypass -File $script -Mode Write
$firstHash = (Get-FileHash -Algorithm SHA256 -LiteralPath (
    Join-Path $repositoryRoot "docs/AI/generated/simulation-unity-execution-tree.md")).Hash
$second = & powershell -NoProfile -ExecutionPolicy Bypass -File $script -Mode Write
$secondHash = (Get-FileHash -Algorithm SHA256 -LiteralPath (
    Join-Path $repositoryRoot "docs/AI/generated/simulation-unity-execution-tree.md")).Hash
$check = & powershell -NoProfile -ExecutionPolicy Bypass -File $script -Mode Check
