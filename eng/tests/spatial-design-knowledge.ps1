...
if ($check -notmatch "SpatialDesignKnowledgeValid:H1=36;H2=18;H3=10") { throw "SpatialDesignKnowledgeCheckFailed" }
if ($write -notmatch "SpatialDesignKnowledgeGenerated:H1=36;H2=18;H3=10") { throw "SpatialDesignKnowledgeWriteFailed" }
...
if ($checkV3 -notmatch "SpatialDesignKnowledgeV3Valid:Grammar=52/156;H1=68\(36\+32\);H2=18;H3=10;H4=5") { throw "SpatialDesignKnowledgeV3CheckFailed" }
if ($writeV3 -notmatch "SpatialDesignKnowledgeV3Generated:Grammar=52/156;H1=68\(36\+32\);H2=18;H3=10;H4=5") { throw "SpatialDesignKnowledgeV3WriteFailed" }
...
Write-Output "SpatialDesignKnowledgeTestsPassed:Grammar=52/156;H1=68(36+32);H2=18;H3=10;H4=5"
