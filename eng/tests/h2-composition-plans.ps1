...
if ($write -notmatch "H2CompositionPlansGenerated:P1=2;Nodes=5;Edges=3;Connectors=6") { throw "H2CompositionWriteFailed" }
...
if ($check -notmatch "H2CompositionPlansValid:P1=2;Nodes=5;Edges=3;Connectors=6") { throw "H2CompositionCheckFailed" }
if ($secondWrite -notmatch "H2CompositionPlansGenerated:P1=2;Nodes=5;Edges=3;Connectors=6") { throw "H2CompositionSecondWriteFailed" }
...
if (@($plans.plans).Count -ne 2) { throw "H2CompositionPlanCountInvalid" }
...
Write-Output "H2CompositionPlanTestsPassed:P1=2;Deterministic=True"
