...
if ($check -notmatch "H2CompositionReadinessValid:H1=52;Used=51;H2=37/37;Theory=37;Authored=6;Derived=31;Unity=6;Review=6;Gameplay=12;TheoryPriority=27;ReviewPriority=5;StrictMissing=8;Warnings=15") { throw "H2ReadinessSummaryUnexpected:$check" }
...
if ([int] $readiness.counts.h2TheoryQualifiedCount -ne 37) { throw "H2TheoryQualifiedCountInvalid" }
if ([int] $readiness.counts.h2AuthoredTheoryRecipeCount -ne 6) { throw "H2AuthoredTheoryRecipeCountInvalid" }
if ([int] $readiness.counts.h2DerivedTheoryRecipeCount -ne 31) { throw "H2DerivedTheoryRecipeCountInvalid" }
...
if ([int] $readiness.counts.h2GameplayTheoryPriorityReadyCount -ne 27) { throw "H2GameplayTheoryPriorityReadyCountInvalid" }
...
if ([int] $readiness.counts.h2WarningOnlyGameplayTraceMissingCount -ne 15) { throw "H2WarningOnlyGameplayTraceCountInvalid" }
...
if ($warningTheoryReady.Count -ne 15) { throw "H2WarningTheoryReadyCountInvalid" }
