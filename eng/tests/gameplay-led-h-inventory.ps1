...
if ($firstWrite -notmatch "GameplayLedHInventoryGenerated:Plans=4;H1=52\+32;H2=38;H3=20;H4=6;Violations=0") { throw "GameplayLedHInventoryFirstWriteFailed" }
if ($check -notmatch "GameplayLedHInventoryValid:Plans=4;H1=52\+32;H2=38;H3=20;H4=6;Violations=0") { throw "GameplayLedHInventoryCheckFailed" }
if ($secondWrite -notmatch "GameplayLedHInventoryGenerated:Plans=4;H1=52\+32;H2=38;H3=20;H4=6;Violations=0") { throw "GameplayLedHInventorySecondWriteFailed" }
...
$natureWiIds = @(
    ...
    "WI-NATURE-05", "WI-NATURE-06", "WI-NATURE-18", "WI-NATURE-07",
    "WI-NATURE-08", "WI-NATURE-09", "WI-NATURE-10", "WI-NATURE-11",
    "WI-NATURE-12"
)
...
if ((@($natureEvidence.currentStageCodes) -join ",") -ne "E1,E4,E6,E7") { throw "GameplayLedHInventoryNatureCurrentStageInvalid" }
if ([string] $natureEvidence.targetStageCode -ne "E7") { throw "GameplayLedHInventoryNatureTargetStageInvalid" }
...
if ([string] $report.policyRevision -ne "simulation-world-gameplay-led-h-policy.r8") { throw "GameplayLedHInventoryPolicyRevisionInvalid" }
...
if ([string] $report.demandRevision -ne "simulation-world-gameplay-h-inventory-demands.r2") { throw "GameplayLedHInventoryDemandRevisionInvalid" }
...
Write-Output "GameplayLedHInventoryTestsPassed:Plans=4;H2=38;H3=20;Demands=5;Violations=0;OrderPacking=Covered"
