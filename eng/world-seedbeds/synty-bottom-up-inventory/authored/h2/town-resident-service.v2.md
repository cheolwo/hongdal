...
@spatial-knowledge h2-candidate:town-resident-service
@hierarchy H2
...
@connector ServiceLoop
@connector PickupOutput

## 존재 이유

근린 서비스 거점과 주민 수령 공간, 회수 안내 창구를 묶어 공동수령과 주민 지원을 수용하는 Town 단독 블록이다.
