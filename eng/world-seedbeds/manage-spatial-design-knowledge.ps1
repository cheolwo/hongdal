...
Require (@($definitionsByLevel.H1).Count -eq 36) "H1CountMustBe36"
...
function New-IndexDocument([hashtable] $ByLevel) {
    ...
    [void] $builder.AppendLine()
    [void] $builder.AppendLine("- H1 작업공간 지식: ``36개``")
...
if ($Mode -eq "Check") {
    ...
    Write-Output "SpatialDesignKnowledgeValid:H1=36;H2=18;H3=10"
}
else {
    ...
    Write-Output "SpatialDesignKnowledgeGenerated:H1=36;H2=18;H3=10"
}
