...
Require (@($definitionsByLevel.H1).Count -eq 41) "H1CountMustBe41"
...
function New-IndexDocument([hashtable] $ByLevel) {
    ...
    [void] $builder.AppendLine()
    [void] $builder.AppendLine("- H1 작업공간 지식: ``41개``")
...
if ($Mode -eq "Check") {
    ...
    Write-Output "SpatialDesignKnowledgeValid:H1=41;H2=18;H3=10"
}
else {
    ...
    Write-Output "SpatialDesignKnowledgeGenerated:H1=41;H2=18;H3=10"
}
