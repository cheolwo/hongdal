...
Require (@($definitionRefsByLevel.H1).Count -eq 36) "InteractionH1CountMustBe36"
...
if ($Mode -eq "Check") {
    Write-Output "SpatialDesignKnowledgeV3Valid:Grammar=52/156;H1=68(36+32);H2=18;H3=10;H4=5"
}
else {
    Write-Output "SpatialDesignKnowledgeV3Generated:Grammar=52/156;H1=68(36+32);H2=18;H3=10;H4=5"
}
