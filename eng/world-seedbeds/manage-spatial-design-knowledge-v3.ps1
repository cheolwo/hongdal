...
Require (@($definitionRefsByLevel.H2).Count -eq 34) "H2CountMustBe34"
Require (@($definitionRefsByLevel.H3).Count -eq 18) "H3CountMustBe18"
...
Require ($h2Recipes.Count -eq 34) "H2RecipeCountMustBe34"
Require (@($h2Recipes.targetKnowledgeRef | Sort-Object -Unique).Count -eq 34) "H2RecipeTargetDuplicate"
...
Require ($h3Recipes.Count -eq 18) "H3RecipeCountMustBe18"
Require (@($h3Recipes.targetKnowledgeRef | Sort-Object -Unique).Count -eq 18) "H3RecipeTargetDuplicate"
...
if ($Mode -eq "Check") {
    Write-Output "SpatialDesignKnowledgeV3Valid:Grammar=52/156;H1=84(52+32);H2=34;H3=18;H4=6"
}
else {
    Write-Output "SpatialDesignKnowledgeV3Generated:Grammar=52/156;H1=84(52+32);H2=34;H3=18;H4=6"
}
