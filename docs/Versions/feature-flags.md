...
커뮤니티 트랙은 특정 버전 하나에 종속하지 않습니다. 1.0에서는 후기, 문의, 감사, 인연 연결, 관계 스냅샷, 개인정보 보호 활동 신호, 커뮤니티 투표와 결의문 초안 같은 기본 신뢰 기록을 보조 모드로 제공하고, 2.5에서는 주문자 집단 공동 주문과 모집/공유로 확장하며, 3.0 이후에는 음식점/배달/알뜰살뜰 마트의 지역 소통과 운영 공유로 이어질 수 있습니다.
...
5. `3.5` 알뜰살뜰 마트는 `HongdalMartV35=true`가 되기 전까지 도심 즉시배송 주문을 피킹/포장/배차 실운영 흐름에 흘려보내지 않습니다.
