...
| 구분 | 내용 |
| --- | --- |
| 목적 | 서버 데이터 속에서 이 운송 의뢰를 지금 어느 기사에게 추천하는 것이 알맞은지 후보를 좁힌다. |
| 입력 | 참여자 입장 해석 결과, `배차대기`, 후보 기사 목록, 기사 실시간 위치, 기사 운행 상태, 차량 적합성 결과, 현재 운송 의뢰 데이터, 거리/시간창 점수, Aging 점수, 추천 라운드, 거절/취소 이력 |
| 출력 | 1순위 추천 후보, 후순위 후보, 제외 후보와 사유, 운영자 확인 사유, DriverApp/HongdalAdmin 설명 문구 |
