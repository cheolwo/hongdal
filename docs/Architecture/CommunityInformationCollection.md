...
| --- | --- | --- |
| `0.0` | 문화교통 · 커뮤니티, 음식·재료 문화, 공공데이터 근거 | 운영 기반 |
| `1.0` | 문화교통 · 공동구매, 여러 재료의 비구속 수요, 주문자 집단화 | 핵심 흐름 |
| `1.5` | 문화교통 · 공급·가격 근거, HS·HTS 후보, 수입·이동 준비 | 현재 통합 범위 |
...
| 정보·시세 | KAMIS, USDA NASS, ABS, 수협 통계, 전통시장, 식약처 수입식품 표시·해외제조업소, 관세청 수입단가·수입요건·관세환율 | KAMIS·USDA·중국 권역·미국 주별 요약만 자동 발행 후보, 나머지는 검토·조회 전용 |
