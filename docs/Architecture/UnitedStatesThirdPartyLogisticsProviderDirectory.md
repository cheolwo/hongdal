...
이 디렉터리는 미국 공동구매·같이 수입 과정에서 참여자들이 필요한 물류 역량을 확인하고 직접 상담할 후보를 찾기 위한 읽기 전용 참고 자료다. 플랫폼이 특정 업체를 추천하거나 운송·보관·통관 업무를 대신 배정하는 목록이 아니다.
