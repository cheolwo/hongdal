...
문화교통 0.0은 커뮤니티와 공공데이터를 독립적인 제품 기반으로 먼저 구성한다. 사용자는 음식·재료의 문화와 가격 근거를 둘러보고, 대화와 모집에서 공동 원장과 다이어그램을 만들며, 참여자가 직접 합의한 업무의 상태와 선택적 증빙을 기록한다. 문화교통 1.0의 공동구매·주문자 집단화와 문화교통 1.5의 공급·가격·무역 준비가 이 기반을 이어받고, 국내 화물/용달 실행은 살뜰 2.0에서 별도 운영 경계를 통과한다.
