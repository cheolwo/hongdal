...
- 기획 분야: `게임플레이 / 명상·내면`
- 기획 판본: `player-mind-meditation.inquiry.r38`
- 상태: `Refining`
- 상위 기획: `PLAN-GAME-COMMON-PURPOSE-001`
- 관련 하위 기획: 없음
- 관련 결정·기준: [게임 상위 목적](../../../../AI/게임상위목적-오행순환과광복기-기획-2026-09-02.md), [WI 괘성 분류](../../../WI괘성분류체계.md)
...
- 내용 개정: `player-mind-meditation.inquiry.r38` (2026-09-03, 직접 NPC 영향과 시설·파티·공동체 간접 영향의 크기·속도 차이 확정; 파일명·고유 식별자 유지)
