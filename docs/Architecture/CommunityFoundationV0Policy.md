...
홍달은 예수의 이웃 사랑과 『대학』의 `수신 -> 제가 -> 치국`이 서로 다른 전통 안에서 보여 주는 공통의 실천 방향을 참고합니다. 가까운 사람의 필요를 알아보고, 자신이 책임질 수 있는 약속부터 세우며, 작은 관계에서 검증된 신뢰를 더 넓은 공동체로 확장합니다.

이 철학은 종교적 동의를 요구하는 서비스 규칙이 아닙니다. 사용자의 종교, 국적, 언어와 가족 형태를 가입·노출·추천·신뢰의 조건으로 사용하지 않습니다. 코드에서는 다음 기준으로 적용합니다.
...
세부 판단 질문과 피해야 할 구현은 [이웃에서 시작하는 공동행동 개발 철학](NeighborCenteredDevelopmentPhilosophy.md)을 따릅니다.
