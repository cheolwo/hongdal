...
홍달은 예수의 이웃 사랑과 『대학』의 `수신 -> 제가 -> 치국`을 같은 실천 원리로 봅니다. 자신을 바로 세우고 가까운 이웃을 사랑하며, 자신이 책임질 수 있는 약속부터 실천해 작은 관계에서 쌓은 신뢰를 더 넓은 공동체로 확장합니다. 세부 판단 질문과 피해야 할 구현은 [이웃에서 시작하는 공동행동 개발 철학](NeighborCenteredDevelopmentPhilosophy.md)을 따릅니다.
