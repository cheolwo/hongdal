# 살뜰 커뮤니티 0.0 기반 제품 원칙

## 제품 정체성

살뜰 0.0은 운송 배차나 특정 물류 업무보다 먼저 **사람들이 모여 대화하고, 필요한 일을 공동 원장과 다이어그램으로 정리하며, 참여자가 직접 합의한 업무를 기록하는 커뮤니티 기반**을 만듭니다.
...
살뜰 0.0의 실제 사용자 흐름은 플랫폼 배차가 아니라 다음과 같은 커뮤니티 대화로 시작합니다.
