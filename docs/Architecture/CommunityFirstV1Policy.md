# 홍달 1.0 커뮤니티 중심 제품 원칙

## 제품 정체성

홍달 1.0의 중심은 운송 배차나 화물 운송 주선이 아니라 **사람들이 모여 대화하고, 필요한 일을 공동 원장과 다이어그램으로 정리하며, 참여자가 직접 합의한 업무를 기록하는 커뮤니티**입니다.
...
홍달 1.0의 실제 사용자 흐름은 플랫폼 배차가 아니라 다음과 같은 커뮤니티 대화로 시작합니다.
...
1. 커뮤니티, 공동 원장, 다이어그램과 기록 기능은 1.0의 기본 기능으로 둡니다.
2. 유상 화물 배차·주선·운임 수취·정산은 개발 코드가 있어도 운영 환경에서 기본 비활성으로 둡니다.
3. 개발 환경에서는 샘플 계정, 샘플 원장, FakePG와 모의 배차만 사용합니다.
4. 실운영 활성화 전에는 관할 행정기관 확인, 허가 보유 사업자와의 제휴 구조 검토, 법률 검토와 운영 약관 정비를 거칩니다.
5. 허가나 영업권의 사적 거래 가격은 공식 고정 가격이 아니므로 제품 문서에 기준 가격으로 적지 않습니다.
