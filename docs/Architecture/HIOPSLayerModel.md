...
현재 0.0의 기준 하위 OS는 `CommunityTrust`다. 공개 정보, 참여 동의, 공동 원장과 완료 사례 환류를 조율하며 후속 실행을 자동 확정하지 않는다. 0.5 개별주문은 한 사람의 원장과 철회를 먼저 안정화하고, [공동구매 수요·모집 OS](GroupPurchaseDemandOS.md)는 동의한 개별주문을 집단화하는 1.0 후속 자산으로 보존한다.
