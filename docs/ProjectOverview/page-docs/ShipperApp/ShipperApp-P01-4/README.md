# ShipperApp-P01-4 - 탐색/제안성 업무 수신함

[전체 화면 문서](../../README.md) / [ShipperApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/ShipperApp/ShipperApp-P01-4.png" alt="ShipperApp-P01-4 화면 캡처" width="720">
...
| --- | --- |
| 앱 | ShipperApp |
| 페이지 ID / 제목 | ShipperApp-P01-4 - 탐색/제안성 업무 수신함 |
| 라우트 | /shipper/exploration/inbox |
| 소스 파일 | [ShipperApp/Components/Pages/ExplorationInbox.razor](../../../../../ShipperApp/Components/Pages/ExplorationInbox.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [ShipperApp-P01-3 - 공개 화물 또는 공개 의뢰 확인](../ShipperApp-P01-3/)
- 다음 화면: [ShipperApp-P02 - 운송 의뢰 작성](../ShipperApp-P02/)
...
- 화면 소스: [ShipperApp/Components/Pages/ExplorationInbox.razor](../../../../../ShipperApp/Components/Pages/ExplorationInbox.razor)
- 클라이언트 서비스/계약: [ShipperApp/Services/IShipperExplorationInquiryService.cs](../../../../../ShipperApp/Services/IShipperExplorationInquiryService.cs), [ShipperApp/Services/탐색문의샘플Service.cs](../../../../../ShipperApp/Services/탐색문의샘플Service.cs)
