# ShipperApp-P00 - 역할 기반 통합 커뮤니티 홈

[전체 화면 문서](../../README.md) / [ShipperApp 화면 목록](../README.md) / [통합 클라이언트 가이드](../../../unified-community-client.md)

## 화면 캡처

<img src="../../../assets/app-pages/ShipperApp/ShipperApp-P00.png" alt="ShipperApp-P00 역할 기반 통합 홈" width="720">

## 기본 정보

| 항목 | 내용 |
| --- | --- |
| 앱 | ShipperApp 기반 Hongdal 통합 클라이언트 |
| 라우트 | `/` |
| 내비게이션 단계 | 공통 셸·1단계 사방괘 진입 |
| 소스 | [UnifiedHome.razor](../../../../../ShipperApp/Components/Pages/UnifiedHome.razor) |
| 분류 | 필수 |
...
주 사용자는 화주와 창고 관리자다. 이 페이지는 `HongdalClientRoleService`의 현재 역할만 판별하고 화주 홈 또는 `WarehouseManagerRoleHome`을 렌더링한다. 커뮤니티·업무 데이터·결제 처리는 하위 화면으로 넘긴다.

## 다른 화면과의 관계

- 우측 상단 사람 버튼: 역할 선택 후 `/`를 다시 연다.
- 화주: [ShipperApp-P01](../ShipperApp-P01/)로 이어진다.
