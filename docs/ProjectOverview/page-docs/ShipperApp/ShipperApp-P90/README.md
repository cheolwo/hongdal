# ShipperApp-P90 - 템플릿/샘플성 날씨 화면

[전체 화면 문서](../../README.md) / [ShipperApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/ShipperApp/ShipperApp-P90.png" alt="ShipperApp-P90 화면 캡처" width="720">
...
| --- | --- |
| 앱 | ShipperApp |
| 페이지 ID / 제목 | ShipperApp-P90 - 템플릿/샘플성 날씨 화면 |
| 라우트 | /weather |
| 소스 파일 | [ShipperApp/Components/Pages/Weather.razor](../../../../../ShipperApp/Components/Pages/Weather.razor) |
| 분류 | 시스템 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [ShipperApp-P08 - 재위탁/재운송 주문](../ShipperApp-P08/)
- 다음 화면: [ShipperApp-P91 - 템플릿/샘플성 카운터 화면](../ShipperApp-P91/)
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [ShipperApp/Components/Pages/Weather.razor](../../../../../ShipperApp/Components/Pages/Weather.razor)
