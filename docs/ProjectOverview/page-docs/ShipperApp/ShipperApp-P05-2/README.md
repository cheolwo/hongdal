# ShipperApp-P05-2 - 창고 스캔 작업

[전체 화면 문서](../../README.md) / [ShipperApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/ShipperApp/ShipperApp-P05-2.png" alt="ShipperApp-P05-2 화면 캡처" width="720">
...
| --- | --- |
| 앱 | ShipperApp |
| 페이지 ID / 제목 | ShipperApp-P05-2 - 창고 스캔 작업 |
| 라우트 | /shipper/warehouse/scan |
| 소스 파일 | [ShipperApp/Components/Pages/WarehouseScanStation.razor](../../../../../ShipperApp/Components/Pages/WarehouseScanStation.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [ShipperApp-P05-1 - 창고 재고 조회](../ShipperApp-P05-1/)
- 다음 화면: [ShipperApp-P05-3 - 창고 프로세스별 작업 시작](../ShipperApp-P05-3/)
...
- 화면 소스: [ShipperApp/Components/Pages/WarehouseScanStation.razor](../../../../../ShipperApp/Components/Pages/WarehouseScanStation.razor)
