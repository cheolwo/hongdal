# ShipperApp-P05-3 - 창고 프로세스별 작업 시작

[전체 화면 문서](../../README.md) / [ShipperApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/ShipperApp/ShipperApp-P05-3.png" alt="ShipperApp-P05-3 화면 캡처" width="720">
...
- 화면 소스: [ShipperApp/Components/Pages/WarehouseWorkStart.razor](../../../../../ShipperApp/Components/Pages/WarehouseWorkStart.razor)
