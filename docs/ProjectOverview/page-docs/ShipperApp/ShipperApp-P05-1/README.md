# ShipperApp-P05-1 - 창고 재고 조회

[전체 화면 문서](../../README.md) / [ShipperApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/ShipperApp/ShipperApp-P05-1.png" alt="ShipperApp-P05-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | ShipperApp |
| 페이지 ID / 제목 | ShipperApp-P05-1 - 창고 재고 조회 |
| 라우트 | /shipper/warehouse/inventory |
| 소스 파일 | [ShipperApp/Components/Pages/WarehouseInventory.razor](../../../../../ShipperApp/Components/Pages/WarehouseInventory.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [ShipperApp-P05 - 화주 관점 창고 업무 허브](../ShipperApp-P05/)
- 다음 화면: [ShipperApp-P05-2 - 창고 스캔 작업](../ShipperApp-P05-2/)
...
- 화면 소스: [ShipperApp/Components/Pages/WarehouseInventory.razor](../../../../../ShipperApp/Components/Pages/WarehouseInventory.razor)
