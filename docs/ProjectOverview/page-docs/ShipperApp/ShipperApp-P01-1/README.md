# ShipperApp-P01-1 - 화주 프로필과 운영 프로필 설정

[전체 화면 문서](../../README.md) / [ShipperApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/ShipperApp/ShipperApp-P01-1.png" alt="ShipperApp-P01-1 화면 캡처" width="720">
...
- 화면 소스: [ShipperApp/Components/Pages/ShipperProfileSettings.razor](../../../../../ShipperApp/Components/Pages/ShipperProfileSettings.razor)
- 클라이언트 서비스/계약: [ShipperApp/Services/Localization/ShipperLocalizationService.cs](../../../../../ShipperApp/Services/Localization/ShipperLocalizationService.cs), [ShipperApp/Services/ShipperOperatingProfileService.cs](../../../../../ShipperApp/Services/ShipperOperatingProfileService.cs)
