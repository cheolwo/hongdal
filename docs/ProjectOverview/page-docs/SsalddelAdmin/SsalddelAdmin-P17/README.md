# SsalddelAdmin-P17 - 의뢰 목록

[전체 화면 문서](../../README.md) / [SsalddelAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelAdmin/SsalddelAdmin-P17.png" alt="SsalddelAdmin-P17 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelAdmin |
| 페이지 ID / 제목 | SsalddelAdmin-P17 - 의뢰 목록 |
| 라우트 | /requests |
| 소스 파일 | [SsalddelAdmin/Components/Pages/Requests.razor](../../../../../SsalddelAdmin/Components/Pages/Requests.razor) |
| 분류 | 필수 |
| 2.0 운송 필수 연결 | [SsalddelAdmin-P17 - 의뢰 목록](../../../ssalddel-v1-required-pages.md) |
| 캡처 상태 | 완료 |
...
이 화면은 살뜰 2.0 국내 화물 운송 워크플로우 안에서 의뢰 목록 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [SsalddelAdmin-P16 - 운영 대시보드](../SsalddelAdmin-P16/)
- 다음 화면: [SsalddelAdmin-P18 - 의뢰 상세](../SsalddelAdmin-P18/)
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [SsalddelAdmin/Components/Pages/Requests.razor](../../../../../SsalddelAdmin/Components/Pages/Requests.razor)
