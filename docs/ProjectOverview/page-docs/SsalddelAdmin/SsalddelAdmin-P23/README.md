...
<img src="../../../assets/app-pages/SsalddelAdmin/SsalddelAdmin-P23.png" alt="SsalddelAdmin-P23 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelAdmin |
| 페이지 ID / 제목 | SsalddelAdmin-P23 - 관리자 활동 로그 |
| 라우트 | /activity-logs |
...
- 이전 화면: [SsalddelAdmin-P22-3 - 운송 정산 상세](../SsalddelAdmin-P22-3/)
- 다음 화면: [SsalddelAdmin-P24 - 화면/기능 노출 정책](../SsalddelAdmin-P24/)
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [SsalddelAdmin/Components/Pages/ActivityLogs.razor](../../../../../SsalddelAdmin/Components/Pages/ActivityLogs.razor)
- 클라이언트 서비스/계약: [SsalddelAdmin/Services/ActivityLogService.cs](../../../../../SsalddelAdmin/Services/ActivityLogService.cs), [SsalddelAdmin/Services/관리자인증세션Service.cs](../../../../../SsalddelAdmin/Services/관리자인증세션Service.cs)
...
| 클라이언트 서비스 | GET | `api/v1/admin/activity-logs/{id}` | [SsalddelAdmin/Services/ActivityLogService.cs](../../../../../SsalddelAdmin/Services/ActivityLogService.cs) | `GET api/v1/admin/activity-logs` [Ssalddel/Controllers/Admin/사용자행위로그Controller.cs](../../../../../Ssalddel/Controllers/Admin/사용자행위로그Controller.cs)<br>`GET api/v1/admin/activity-logs/{id:long}` [Ssalddel/Controllers/Admin/사용자행위로그Controller.cs](../../../../../Ssalddel/Controllers/Admin/사용자행위로그Controller.cs) |
| 클라이언트 서비스 | GET | `api/v1/admin/activity-logs/trace/{traceId}` | [SsalddelAdmin/Services/ActivityLogService.cs](../../../../../SsalddelAdmin/Services/ActivityLogService.cs) | `GET api/v1/admin/activity-logs` [Ssalddel/Controllers/Admin/사용자행위로그Controller.cs](../../../../../Ssalddel/Controllers/Admin/사용자행위로그Controller.cs)<br>`GET api/v1/admin/activity-logs/trace/{traceId}` [Ssalddel/Controllers/Admin/사용자행위로그Controller.cs](../../../../../Ssalddel/Controllers/Admin/사용자행위로그Controller.cs) |
