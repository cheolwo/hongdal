# SsalddelAdmin-P27 - 문서 목록

[전체 화면 문서](../../README.md) / [SsalddelAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelAdmin/SsalddelAdmin-P27.png" alt="SsalddelAdmin-P27 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelAdmin |
| 페이지 ID / 제목 | SsalddelAdmin-P27 - 문서 목록 |
| 라우트 | /documents |
| 소스 파일 | [SsalddelAdmin/Components/Pages/Documents.razor](../../../../../SsalddelAdmin/Components/Pages/Documents.razor) |
| 분류 | 필수 |
| 2.0 운송 필수 연결 | [SsalddelAdmin-P27 - 문서 목록](../../../ssalddel-v1-required-pages.md) |
| 캡처 상태 | 완료 |

## 왜 필요한가

이 화면은 문서 목록을 담당하므로, 1.0 업무 흐름이 실제 사용자 행동으로 닫히기 위해 필요합니다.

## 사용자와 참여자

주 사용자: 관리자, 운영자 / 보조 참여자: 화주, 기사, 파트너, 문서 담당자

이 화면은 살뜰 2.0 국내 화물 운송 워크플로우 안에서 문서 목록 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [SsalddelAdmin-P26-1 - 정산 목록](../SsalddelAdmin-P26-1/)
- 다음 화면: [SsalddelAdmin-P27-1 - 문서 업로드](../SsalddelAdmin-P27-1/)
- 상위 화면: 없음
- 하위 화면: [SsalddelAdmin-P27-1 - 문서 업로드](../SsalddelAdmin-P27-1/), [SsalddelAdmin-P27-2 - 문서 정책 목록](../SsalddelAdmin-P27-2/), [SsalddelAdmin-P27-3 - 문서 정책 상세](../SsalddelAdmin-P27-3/), [SsalddelAdmin-P27-4 - 문서 조회 로그](../SsalddelAdmin-P27-4/), [SsalddelAdmin-P27-5 - 파일/POD 관리](../SsalddelAdmin-P27-5/)

상호작용 관점에서는 다음 흐름을 우선 봅니다. 관리자는 여러 앱에서 발생한 상태 변경을 모아 보고, 막힌 배차·증빙·정산·문서 문제에 개입합니다.

## API 경로와 코드 연결

- 화면 소스: [SsalddelAdmin/Components/Pages/Documents.razor](../../../../../SsalddelAdmin/Components/Pages/Documents.razor)
- 클라이언트 서비스/계약: [SsalddelAdmin/Services/관리자인증세션Service.cs](../../../../../SsalddelAdmin/Services/관리자인증세션Service.cs), [SsalddelAdmin/Services/문서관리메모리Service.cs](../../../../../SsalddelAdmin/Services/문서관리메모리Service.cs)
