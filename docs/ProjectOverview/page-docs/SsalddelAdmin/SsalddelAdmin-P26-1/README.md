# SsalddelAdmin-P26-1 - 정산 목록

[전체 화면 문서](../../README.md) / [SsalddelAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelAdmin/SsalddelAdmin-P26-1.png" alt="SsalddelAdmin-P26-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelAdmin |
| 페이지 ID / 제목 | SsalddelAdmin-P26-1 - 정산 목록 |
| 라우트 | /settlements |
| 소스 파일 | [SsalddelAdmin/Components/Pages/Settlements.razor](../../../../../SsalddelAdmin/Components/Pages/Settlements.razor) |
| 분류 | 필수 |
| 2.0 운송 필수 연결 | [SsalddelAdmin-P26-1 - 정산 목록](../../../ssalddel-v1-required-pages.md) |
| 캡처 상태 | 완료 |
...
이 화면은 살뜰 2.0 국내 화물 운송 워크플로우 안에서 정산 목록 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [SsalddelAdmin-P26 - 결제 목록](../SsalddelAdmin-P26/)
- 다음 화면: [SsalddelAdmin-P27 - 문서 목록](../SsalddelAdmin-P27/)
- 상위 화면: [SsalddelAdmin-P26 - 결제 목록](../SsalddelAdmin-P26/)
- 하위 화면: 없음
...
- 화면 소스: [SsalddelAdmin/Components/Pages/Settlements.razor](../../../../../SsalddelAdmin/Components/Pages/Settlements.razor)
...
| 클라이언트 서비스 | - | `api/v1/admin/driver-settlements` | [SsalddelAdmin/Services/백오피스조회Service.cs](../../../../../SsalddelAdmin/Services/백오피스조회Service.cs) | `GET api/v1/admin/driver-settlements` [Ssalddel/Controllers/Admin/05_정산/기사월정산관리Controller.cs](../../../../../Ssalddel/Controllers/Admin/05_정산/기사월정산관리Controller.cs) |
