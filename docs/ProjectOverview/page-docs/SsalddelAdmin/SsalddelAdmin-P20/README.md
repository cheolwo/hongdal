# SsalddelAdmin-P20 - 운행 중 기사 현황

[전체 화면 문서](../../README.md) / [SsalddelAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelAdmin/SsalddelAdmin-P20.png" alt="SsalddelAdmin-P20 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelAdmin |
| 페이지 ID / 제목 | SsalddelAdmin-P20 - 운행 중 기사 현황 |
...
- 이전 화면: [SsalddelAdmin-P19 - 배차대기/추천 잠금 상태](../SsalddelAdmin-P19/)
- 다음 화면: [SsalddelAdmin-P21 - 운송 목록](../SsalddelAdmin-P21/)
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [SsalddelAdmin/Components/Pages/DriverOperatingView.razor](../../../../../SsalddelAdmin/Components/Pages/DriverOperatingView.razor)
