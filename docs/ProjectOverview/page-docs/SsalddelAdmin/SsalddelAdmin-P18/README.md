# SsalddelAdmin-P18 - 의뢰 상세

[전체 화면 문서](../../README.md) / [SsalddelAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelAdmin/SsalddelAdmin-P18.png" alt="SsalddelAdmin-P18 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelAdmin |
| 페이지 ID / 제목 | SsalddelAdmin-P18 - 의뢰 상세 |
| 라우트 | /requests/{RequestId} |
| 소스 파일 | [SsalddelAdmin/Components/Pages/RequestDetail.razor](../../../../../SsalddelAdmin/Components/Pages/RequestDetail.razor) |
| 분류 | 필수 |
| 2.0 운송 필수 연결 | [SsalddelAdmin-P18 - 의뢰 상세](../../../ssalddel-v1-required-pages.md) |
| 캡처 상태 | 완료 |

## 왜 필요한가

이 화면은 의뢰 상세을 담당하므로, 1.0 업무 흐름이 실제 사용자 행동으로 닫히기 위해 필요합니다.

## 사용자와 참여자

주 사용자: 관리자, 운영자 / 보조 참여자: 화주, 기사, 파트너, 문서 담당자

이 화면은 살뜰 2.0 국내 화물 운송 워크플로우 안에서 의뢰 상세 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [SsalddelAdmin-P17 - 의뢰 목록](../SsalddelAdmin-P17/)
- 다음 화면: [SsalddelAdmin-P19 - 배차대기/추천 잠금 상태](../SsalddelAdmin-P19/)
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [SsalddelAdmin/Components/Pages/RequestDetail.razor](../../../../../SsalddelAdmin/Components/Pages/RequestDetail.razor)
