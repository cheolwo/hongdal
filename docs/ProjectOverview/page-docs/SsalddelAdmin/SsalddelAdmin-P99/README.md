# SsalddelAdmin-P99 - 미발견 페이지

[전체 화면 문서](../../README.md) / [SsalddelAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelAdmin/SsalddelAdmin-P99.png" alt="SsalddelAdmin-P99 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelAdmin |
| 페이지 ID / 제목 | SsalddelAdmin-P99 - 미발견 페이지 |
| 라우트 | /not-found |
| 소스 파일 | [SsalddelAdmin/Components/Pages/NotFound.razor](../../../../../SsalddelAdmin/Components/Pages/NotFound.razor) |
| 분류 | 시스템 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
이 화면은 앱 운영/라우팅 보조 워크플로우 안에서 미발견 페이지 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [SsalddelAdmin-P91 - 템플릿/샘플성 카운터 화면](../SsalddelAdmin-P91/)
- 다음 화면: 없음
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [SsalddelAdmin/Components/Pages/NotFound.razor](../../../../../SsalddelAdmin/Components/Pages/NotFound.razor)
