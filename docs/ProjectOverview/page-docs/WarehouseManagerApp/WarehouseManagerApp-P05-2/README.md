...
<img src="../../../assets/app-pages/WarehouseManagerApp/WarehouseManagerApp-P05-2.png" alt="WarehouseManagerApp-P05-2 화면 캡처" width="720">
...
| 페이지 ID | WarehouseManagerApp-P05-2 |
...
- 이전 화면: [WarehouseManagerApp-P05-1](../WarehouseManagerApp-P05-1/)
- 다음 화면: [WarehouseManagerApp-P99](../WarehouseManagerApp-P99/)
