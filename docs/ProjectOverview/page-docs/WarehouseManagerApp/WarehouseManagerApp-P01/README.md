# WarehouseManagerApp-P01 - 창고 관리자 홈

[전체 화면 문서](../../README.md) / [WarehouseManagerApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/WarehouseManagerApp/WarehouseManagerApp-P01.png" alt="WarehouseManagerApp-P01 화면 캡처" width="720">
...
이 화면은 창고 관리자 홈을 담당하므로, 주 업무 화면을 보조하고 사용자가 다음 행동으로 이동할 수 있게 합니다.

## 사용자와 참여자

주 사용자: 창고 관리자, 창고 작업자 / 보조 참여자: 화주, 기사, 관리자

이 화면은 창고/출고/피킹 확장 워크플로우 안에서 창고 관리자 홈 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 화면 소스: [WarehouseManagerApp/Components/Pages/Home.razor](../../../../../WarehouseManagerApp/Components/Pages/Home.razor)
