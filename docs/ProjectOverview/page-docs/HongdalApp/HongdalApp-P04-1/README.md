# HongdalApp-P04-1 - 입고 요청 목록과 처리

[전체 화면 문서](../../README.md) / [HongdalApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalApp/HongdalApp-P04-1.png" alt="HongdalApp-P04-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalApp |
| 페이지 ID / 제목 | HongdalApp-P04-1 - 입고 요청 목록과 처리 |
| 라우트 | /shipper/inbound/requests |
| 소스 파일 | [HongdalApp/Components/Pages/InboundRequests.razor](../../../../../HongdalApp/Components/Pages/InboundRequests.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalApp-P04 - 화주 입고 업무 대시보드](../HongdalApp-P04/)
- 다음 화면: [HongdalApp-P05 - 화주 관점 창고 업무 허브](../HongdalApp-P05/)
- 상위 화면: [HongdalApp-P04 - 화주 입고 업무 대시보드](../HongdalApp-P04/)
- 하위 화면: 없음
...
- 화면 소스: [HongdalApp/Components/Pages/InboundRequests.razor](../../../../../HongdalApp/Components/Pages/InboundRequests.razor)
