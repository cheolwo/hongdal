# HongdalApp-P05-3 - 창고 프로세스별 작업 시작

[전체 화면 문서](../../README.md) / [HongdalApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalApp/HongdalApp-P05-3.png" alt="HongdalApp-P05-3 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalApp |
| 페이지 ID / 제목 | HongdalApp-P05-3 - 창고 프로세스별 작업 시작 |
| 라우트 | /shipper/warehouse/work/{ProcessCode} |
| 소스 파일 | [HongdalApp/Components/Pages/WarehouseWorkStart.razor](../../../../../HongdalApp/Components/Pages/WarehouseWorkStart.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalApp-P05-2 - 창고 스캔 작업](../HongdalApp-P05-2/)
- 다음 화면: [HongdalApp-P06 - 판매채널 연결/관리](../HongdalApp-P06/)
...
- 화면 소스: [HongdalApp/Components/Pages/WarehouseWorkStart.razor](../../../../../HongdalApp/Components/Pages/WarehouseWorkStart.razor)
