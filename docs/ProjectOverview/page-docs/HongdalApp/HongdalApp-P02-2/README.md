# HongdalApp-P02-2 - 배차 주소 입력/검증 폼

[전체 화면 문서](../../README.md) / [HongdalApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalApp/HongdalApp-P02-2.png" alt="HongdalApp-P02-2 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalApp |
| 페이지 ID / 제목 | HongdalApp-P02-2 - 배차 주소 입력/검증 폼 |
| 라우트 | /dispatch/address-form |
| 소스 파일 | [HongdalApp/Components/Pages/DispatchAddressForm.razor](../../../../../HongdalApp/Components/Pages/DispatchAddressForm.razor) |
| 분류 | 보조 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalApp-P02-1 - 운송 의뢰 대량 등록](../HongdalApp-P02-1/)
- 다음 화면: [HongdalApp-P03 - 의뢰 상세, 결제/배차/상차/하차/정산 타임라인](../HongdalApp-P03/)
...
- 화면 소스: [HongdalApp/Components/Pages/DispatchAddressForm.razor](../../../../../HongdalApp/Components/Pages/DispatchAddressForm.razor)
