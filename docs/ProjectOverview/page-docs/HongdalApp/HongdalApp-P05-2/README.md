# HongdalApp-P05-2 - 창고 스캔 작업

[전체 화면 문서](../../README.md) / [HongdalApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalApp/HongdalApp-P05-2.png" alt="HongdalApp-P05-2 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalApp |
| 페이지 ID / 제목 | HongdalApp-P05-2 - 창고 스캔 작업 |
| 라우트 | /shipper/warehouse/scan |
| 소스 파일 | [HongdalApp/Components/Pages/WarehouseScanStation.razor](../../../../../HongdalApp/Components/Pages/WarehouseScanStation.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalApp-P05-1 - 창고 재고 조회](../HongdalApp-P05-1/)
- 다음 화면: [HongdalApp-P05-3 - 창고 프로세스별 작업 시작](../HongdalApp-P05-3/)
...
- 화면 소스: [HongdalApp/Components/Pages/WarehouseScanStation.razor](../../../../../HongdalApp/Components/Pages/WarehouseScanStation.razor)
