# HongdalApp-P04 - 화주 입고 업무 대시보드

[전체 화면 문서](../../README.md) / [HongdalApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalApp/HongdalApp-P04.png" alt="HongdalApp-P04 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalApp |
| 페이지 ID / 제목 | HongdalApp-P04 - 화주 입고 업무 대시보드 |
| 라우트 | /shipper/inbound/dashboard |
| 소스 파일 | [HongdalApp/Components/Pages/InboundDashboard.razor](../../../../../HongdalApp/Components/Pages/InboundDashboard.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalApp-P03 - 의뢰 상세, 결제/배차/상차/하차/정산 타임라인](../HongdalApp-P03/)
- 다음 화면: [HongdalApp-P04-1 - 입고 요청 목록과 처리](../HongdalApp-P04-1/)
- 상위 화면: 없음
- 하위 화면: [HongdalApp-P04-1 - 입고 요청 목록과 처리](../HongdalApp-P04-1/)

상호작용 관점에서는 다음 흐름을 우선 봅니다. 화주가 입력하거나 확인한 의뢰/결제/창고 상태는 기사 앱의 추천, 관리자 원장, 창고 작업 화면으로 이어질 수 있습니다.

## API 경로와 코드 연결

- 화면 소스: [HongdalApp/Components/Pages/InboundDashboard.razor](../../../../../HongdalApp/Components/Pages/InboundDashboard.razor)
