# HongdalApp-P01-4 - 탐색/제안성 업무 수신함

[전체 화면 문서](../../README.md) / [HongdalApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalApp/HongdalApp-P01-4.png" alt="HongdalApp-P01-4 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalApp |
| 페이지 ID / 제목 | HongdalApp-P01-4 - 탐색/제안성 업무 수신함 |
| 라우트 | /shipper/exploration/inbox |
| 소스 파일 | [HongdalApp/Components/Pages/ExplorationInbox.razor](../../../../../HongdalApp/Components/Pages/ExplorationInbox.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalApp-P01-3 - 공개 화물 또는 공개 의뢰 확인](../HongdalApp-P01-3/)
- 다음 화면: [HongdalApp-P02 - 운송 의뢰 작성](../HongdalApp-P02/)
...
- 화면 소스: [HongdalApp/Components/Pages/ExplorationInbox.razor](../../../../../HongdalApp/Components/Pages/ExplorationInbox.razor)
- 클라이언트 서비스/계약: [HongdalApp/Services/IShipperExplorationInquiryService.cs](../../../../../HongdalApp/Services/IShipperExplorationInquiryService.cs), [HongdalApp/Services/탐색문의샘플Service.cs](../../../../../HongdalApp/Services/탐색문의샘플Service.cs)
