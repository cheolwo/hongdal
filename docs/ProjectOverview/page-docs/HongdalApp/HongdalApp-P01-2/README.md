# HongdalApp-P01-2 - 화주 앱 메뉴/화면 노출 설정

[전체 화면 문서](../../README.md) / [HongdalApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalApp/HongdalApp-P01-2.png" alt="HongdalApp-P01-2 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalApp |
| 페이지 ID / 제목 | HongdalApp-P01-2 - 화주 앱 메뉴/화면 노출 설정 |
| 라우트 | /shipper/settings/views |
| 소스 파일 | [HongdalApp/Components/Pages/ShipperViewSettings.razor](../../../../../HongdalApp/Components/Pages/ShipperViewSettings.razor) |
| 분류 | 보조 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalApp-P01-1 - 화주 프로필과 운영 프로필 설정](../HongdalApp-P01-1/)
- 다음 화면: [HongdalApp-P01-3 - 공개 화물 또는 공개 의뢰 확인](../HongdalApp-P01-3/)
...
- 화면 소스: [HongdalApp/Components/Pages/ShipperViewSettings.razor](../../../../../HongdalApp/Components/Pages/ShipperViewSettings.razor)
- 클라이언트 서비스/계약: [HongdalApp/Services/ShipperViewVisibilityService.cs](../../../../../HongdalApp/Services/ShipperViewVisibilityService.cs)
