# HongdalApp-P05 - 화주 관점 창고 업무 허브

[전체 화면 문서](../../README.md) / [HongdalApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalApp/HongdalApp-P05.png" alt="HongdalApp-P05 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalApp |
| 페이지 ID / 제목 | HongdalApp-P05 - 화주 관점 창고 업무 허브 |
| 라우트 | /shipper/warehouse/workspace |
| 소스 파일 | [HongdalApp/Components/Pages/WarehouseWorkspace.razor](../../../../../HongdalApp/Components/Pages/WarehouseWorkspace.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalApp-P04-1 - 입고 요청 목록과 처리](../HongdalApp-P04-1/)
- 다음 화면: [HongdalApp-P05-1 - 창고 재고 조회](../HongdalApp-P05-1/)
- 상위 화면: 없음
- 하위 화면: [HongdalApp-P05-1 - 창고 재고 조회](../HongdalApp-P05-1/), [HongdalApp-P05-2 - 창고 스캔 작업](../HongdalApp-P05-2/), [HongdalApp-P05-3 - 창고 프로세스별 작업 시작](../HongdalApp-P05-3/)

상호작용 관점에서는 다음 흐름을 우선 봅니다. 화주가 입력하거나 확인한 의뢰/결제/창고 상태는 기사 앱의 추천, 관리자 원장, 창고 작업 화면으로 이어질 수 있습니다.

## API 경로와 코드 연결

- 화면 소스: [HongdalApp/Components/Pages/WarehouseWorkspace.razor](../../../../../HongdalApp/Components/Pages/WarehouseWorkspace.razor)
