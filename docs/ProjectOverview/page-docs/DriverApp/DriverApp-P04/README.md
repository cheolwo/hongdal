# DriverApp-P04 - 탐색 캠페인/추천 확장

[전체 화면 문서](../../README.md) / [DriverApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/DriverApp/DriverApp-P04.png" alt="DriverApp-P04 화면 캡처" width="720">
...
이 화면은 탐색 캠페인/추천 확장을 담당하므로, 1.0 이후의 해외 물류, 창고, 주문자 집단, 판매채널 확장을 화면 단위로 검증하기 위해 필요합니다.

## 사용자와 참여자

주 사용자: 기사 / 보조 참여자: 화주, 관리자, 창고 또는 현장 담당자

이 화면은 보조 또는 확장 업무 워크플로우 안에서 탐색 캠페인/추천 확장 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 화면 소스: [DriverApp/Components/Pages/Driver/02_Recommendation/탐색캠페인Page.razor](../../../../../DriverApp/Components/Pages/Driver/02_Recommendation/탐색캠페인Page.razor)
- 클라이언트 서비스/계약: [DriverApp/Services/Samples/IDriverExplorationCampaignService.cs](../../../../../DriverApp/Services/Samples/IDriverExplorationCampaignService.cs), [DriverApp/Services/Samples/탐색캠페인샘플Service.cs](../../../../../DriverApp/Services/Samples/탐색캠페인샘플Service.cs)
