# DriverApp-P10 - 추천 수락/거절/보류 처리

[전체 화면 문서](../../README.md) / [DriverApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/DriverApp/DriverApp-P10.png" alt="DriverApp-P10 화면 캡처" width="720">
...
| 분류 | 필수 |
| 2.0 운송 필수 연결 | [DriverApp-P10 - 추천 수락/거절/보류 처리](../../../ssalddel-v1-required-pages.md) |
| 캡처 상태 | 완료 |

## 왜 필요한가

이 화면은 추천 수락/거절/보류 처리을 담당하므로, 1.0 업무 흐름이 실제 사용자 행동으로 닫히기 위해 필요합니다.

## 사용자와 참여자

주 사용자: 기사 / 보조 참여자: 화주, 관리자, 창고 또는 현장 담당자

이 화면은 살뜰 2.0 국내 화물 운송 워크플로우 안에서 추천 수락/거절/보류 처리 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 화면 소스: [DriverApp/Components/Pages/Driver/02_Recommendation/배차처리Page.razor](../../../../../DriverApp/Components/Pages/Driver/02_Recommendation/배차처리Page.razor)
