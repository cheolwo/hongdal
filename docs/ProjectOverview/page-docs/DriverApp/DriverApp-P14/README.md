...
| 분류 | 필수 |
| 1.0 필수 연결 | [DriverApp-P14](../../../hongdal-v1-required-pages.md) |
| 캡처 상태 | 완료 |
...
이 화면은 홍달 1.0 국내 화물 운송 워크플로우 안에서 월정산 확인 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [DriverApp-P13](../DriverApp-P13/)
- 다음 화면: [DriverApp-P14-1](../DriverApp-P14-1/)
- 상위 화면: 없음
- 하위 화면: [DriverApp-P14-1](../DriverApp-P14-1/), [DriverApp-P14-2](../DriverApp-P14-2/)
...
| --- | --- | --- | --- | --- |
| 1.0 문서 | - | `api/v1/driver/settlements` | [docs/ProjectOverview/hongdal-v1-required-pages.md](../../../hongdal-v1-required-pages.md) | `GET api/v1/driver/settlements` [Hongdal/Controllers/Driver/06_Settlement/기사정산Controller.cs](../../../../../Hongdal/Controllers/Driver/06_Settlement/기사정산Controller.cs)<br>`GET api/v1/driver/settlements/{year:int}/{month:int}` [Hongdal/Controllers/Driver/06_Settlement/기사정산Controller.cs](../../../../../Hongdal/Controllers/Driver/06_Settlement/기사정산Controller.cs)<br>`GET api/v1/driver/settlements/current-month` [Hongdal/Controllers/Driver/06_Settlement/기사정산Controller.cs](../../../../../Hongdal/Controllers/Driver/06_Settlement/기사정산Controller.cs) |
