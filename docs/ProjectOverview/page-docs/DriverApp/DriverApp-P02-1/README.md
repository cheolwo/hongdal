# DriverApp-P02-1 - 기사 앱 화면 노출 설정

[전체 화면 문서](../../README.md) / [DriverApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/DriverApp/DriverApp-P02-1.png" alt="DriverApp-P02-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | DriverApp |
| 페이지 ID / 제목 | DriverApp-P02-1 - 기사 앱 화면 노출 설정 |
| 라우트 | /driver/settings/views |
| 소스 파일 | [DriverApp/Components/Pages/Driver/04_Settings/화면설정Page.razor](../../../../../DriverApp/Components/Pages/Driver/04_Settings/화면설정Page.razor) |
| 분류 | 보조 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
이 화면은 기사 앱 화면 노출 설정을 담당하므로, 주 업무 화면을 보조하고 사용자가 다음 행동으로 이동할 수 있게 합니다.

## 사용자와 참여자

주 사용자: 기사 / 보조 참여자: 화주, 관리자, 창고 또는 현장 담당자

이 화면은 보조 또는 확장 업무 워크플로우 안에서 기사 앱 화면 노출 설정 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [DriverApp-P02 - 기사 앱 메뉴](../DriverApp-P02/)
- 다음 화면: [DriverApp-P03 - 예약 운송 또는 예약 업무](../DriverApp-P03/)
- 상위 화면: [DriverApp-P02 - 기사 앱 메뉴](../DriverApp-P02/)
- 하위 화면: 없음
...
- 화면 소스: [DriverApp/Components/Pages/Driver/04_Settings/화면설정Page.razor](../../../../../DriverApp/Components/Pages/Driver/04_Settings/화면설정Page.razor)
- 클라이언트 서비스/계약: [DriverApp/Services/DriverHomeDisplayPreferenceService.cs](../../../../../DriverApp/Services/DriverHomeDisplayPreferenceService.cs), [DriverApp/Services/DriverViewVisibilityService.cs](../../../../../DriverApp/Services/DriverViewVisibilityService.cs), [DriverApp/Services/IDriverSampleDataService.cs](../../../../../DriverApp/Services/IDriverSampleDataService.cs), [DriverApp/Services/Samples/ServerBackedDriverSampleDataService.cs](../../../../../DriverApp/Services/Samples/ServerBackedDriverSampleDataService.cs), [DriverApp/Services/Samples/기사샘플데이터Service.cs](../../../../../DriverApp/Services/Samples/기사샘플데이터Service.cs), [DriverApp/Services/추천카드표시설정Service.cs](../../../../../DriverApp/Services/추천카드표시설정Service.cs)
