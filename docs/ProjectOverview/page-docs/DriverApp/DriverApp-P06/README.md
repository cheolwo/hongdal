...
| 분류 | 필수 |
| 1.0 필수 연결 | [DriverApp-P06](../../../hongdal-v1-required-pages.md) |
| 캡처 상태 | 완료 |
...
이 화면은 홍달 1.0 국내 화물 운송 워크플로우 안에서 운행 시작, 위치 송신 시작 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [DriverApp-P05](../DriverApp-P05/)
- 다음 화면: [DriverApp-P06-1](../DriverApp-P06-1/)
- 상위 화면: 없음
- 하위 화면: [DriverApp-P06-1](../DriverApp-P06-1/)
...
| --- | --- | --- | --- | --- |
| 1.0 문서 | - | `api/v1/driver/shifts` | [docs/ProjectOverview/hongdal-v1-required-pages.md](../../../hongdal-v1-required-pages.md) | `GET api/v1/driver/shifts` [Hongdal/Controllers/Driver/01_Work/기사근무Controller.cs](../../../../../Hongdal/Controllers/Driver/01_Work/기사근무Controller.cs)<br>`GET api/v1/driver/shifts/{id:long}` [Hongdal/Controllers/Driver/01_Work/기사근무Controller.cs](../../../../../Hongdal/Controllers/Driver/01_Work/기사근무Controller.cs) |
| 1.0 문서 | - | `api/v1/driver/work` | [docs/ProjectOverview/hongdal-v1-required-pages.md](../../../hongdal-v1-required-pages.md) | `GET api/v1/driver/work/status` [Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs](../../../../../Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs)<br>`GET api/v1/driver/work/current` [Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs](../../../../../Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs)<br>`POST api/v1/driver/work/start` [Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs](../../../../../Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs)<br>`POST api/v1/driver/work/stop` [Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs](../../../../../Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs) |
...
| 클라이언트 서비스 | POST | `api/v1/driver/work/start` | [DriverApp/Services/DriverWorkApiService.cs](../../../../../DriverApp/Services/DriverWorkApiService.cs) | `POST api/v1/driver/work/start` [Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs](../../../../../Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs) |
| 클라이언트 서비스 | POST | `api/v1/driver/work/stop` | [DriverApp/Services/DriverWorkApiService.cs](../../../../../DriverApp/Services/DriverWorkApiService.cs) | `POST api/v1/driver/work/stop` [Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs](../../../../../Hongdal/Controllers/Driver/01_Work/기사운행Controller.cs) |
