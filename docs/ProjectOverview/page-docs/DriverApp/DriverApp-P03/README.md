# DriverApp-P03 - 예약 운송 또는 예약 업무

[전체 화면 문서](../../README.md) / [DriverApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/DriverApp/DriverApp-P03.png" alt="DriverApp-P03 화면 캡처" width="720">
...
| --- | --- |
| 앱 | DriverApp |
| 페이지 ID / 제목 | DriverApp-P03 - 예약 운송 또는 예약 업무 |
| 라우트 | /driver/reservations |
| 소스 파일 | [DriverApp/Components/Pages/Driver/04_Reservation/예약Page.razor](../../../../../DriverApp/Components/Pages/Driver/04_Reservation/예약Page.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
이 화면은 예약 운송 또는 예약 업무을 담당하므로, 1.0 이후의 해외 물류, 창고, 주문자 집단, 판매채널 확장을 화면 단위로 검증하기 위해 필요합니다.

## 사용자와 참여자

주 사용자: 기사 / 보조 참여자: 화주, 관리자, 창고 또는 현장 담당자

이 화면은 보조 또는 확장 업무 워크플로우 안에서 예약 운송 또는 예약 업무 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [DriverApp-P02-1 - 기사 앱 화면 노출 설정](../DriverApp-P02-1/)
- 다음 화면: [DriverApp-P04 - 탐색 캠페인/추천 확장](../DriverApp-P04/)
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [DriverApp/Components/Pages/Driver/04_Reservation/예약Page.razor](../../../../../DriverApp/Components/Pages/Driver/04_Reservation/예약Page.razor)
