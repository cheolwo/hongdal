# DriverApp-P14-1 - 이용료/정산 정책 안내

[전체 화면 문서](../../README.md) / [DriverApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/DriverApp/DriverApp-P14-1.png" alt="DriverApp-P14-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | DriverApp |
| 페이지 ID / 제목 | DriverApp-P14-1 - 이용료/정산 정책 안내 |
| 라우트 | /driver/settlements/info |
| 소스 파일 | [DriverApp/Components/Pages/Driver/05_Settlement/이용료안내Page.razor](../../../../../DriverApp/Components/Pages/Driver/05_Settlement/이용료안내Page.razor) |
| 분류 | 보조 |
| 2.0 운송 필수 연결 | [DriverApp-P14-1 - 이용료/정산 정책 안내](../../../ssalddel-v1-required-pages.md) |
| 캡처 상태 | 완료 |

## 왜 필요한가

이 화면은 이용료/정산 정책 안내을 담당하므로, 주 업무 화면을 보조하고 사용자가 다음 행동으로 이동할 수 있게 합니다.

## 사용자와 참여자

주 사용자: 기사 / 보조 참여자: 화주, 관리자, 창고 또는 현장 담당자

이 화면은 살뜰 2.0 국내 화물 운송 워크플로우 안에서 이용료/정산 정책 안내 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [DriverApp-P14 - 월정산 확인](../DriverApp-P14/)
- 다음 화면: [DriverApp-P14-2 - 기사 정산 계좌 정보](../DriverApp-P14-2/)
...
- 화면 소스: [DriverApp/Components/Pages/Driver/05_Settlement/이용료안내Page.razor](../../../../../DriverApp/Components/Pages/Driver/05_Settlement/이용료안내Page.razor)
