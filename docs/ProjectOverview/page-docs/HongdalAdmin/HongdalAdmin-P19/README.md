# HongdalAdmin-P19 - 배차대기/추천 잠금 상태

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P19.png" alt="HongdalAdmin-P19 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalAdmin |
| 페이지 ID / 제목 | HongdalAdmin-P19 - 배차대기/추천 잠금 상태 |
| 라우트 | /dispatch/wait |
| 소스 파일 | [HongdalAdmin/Components/Pages/DispatchWait.razor](../../../../../HongdalAdmin/Components/Pages/DispatchWait.razor) |
| 분류 | 필수 |
| 1.0 필수 연결 | [HongdalAdmin-P19 - 배차대기/추천 잠금 상태](../../../hongdal-v1-required-pages.md) |
| 캡처 상태 | 완료 |
...
이 화면은 홍달 1.0 국내 화물 운송 워크플로우 안에서 배차대기/추천 잠금 상태 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [HongdalAdmin-P18 - 의뢰 상세](../HongdalAdmin-P18/)
- 다음 화면: [HongdalAdmin-P20 - 운행 중 기사 현황](../HongdalAdmin-P20/)
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [HongdalAdmin/Components/Pages/DispatchWait.razor](../../../../../HongdalAdmin/Components/Pages/DispatchWait.razor)
...
| 클라이언트 서비스 | - | `api/v1/dispatch/wait` | [HongdalAdmin/Services/백오피스조회Service.cs](../../../../../HongdalAdmin/Services/백오피스조회Service.cs) | `GET api/v1/dispatch/wait` [Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs](../../../../../Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs)<br>`GET api/v1/dispatch/wait/{id:long}` [Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs](../../../../../Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs)<br>`POST api/v1/dispatch/wait` [Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs](../../../../../Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs)<br>`PUT api/v1/dispatch/wait/{id:long}` [Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs](../../../../../Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs) |
| 클라이언트 서비스 | DELETE | `api/v1/dispatch/wait/{id}` | [HongdalAdmin/Services/백오피스조회Service.cs](../../../../../HongdalAdmin/Services/백오피스조회Service.cs) | `DELETE api/v1/dispatch/wait/{id:long}` [Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs](../../../../../Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs) |
| 클라이언트 서비스 | GET | `api/v1/dispatch/wait/{id}` | [HongdalAdmin/Services/백오피스조회Service.cs](../../../../../HongdalAdmin/Services/백오피스조회Service.cs) | `GET api/v1/dispatch/wait` [Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs](../../../../../Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs)<br>`GET api/v1/dispatch/wait/{id:long}` [Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs](../../../../../Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs) |
| 클라이언트 서비스 | PUT | `api/v1/dispatch/wait/{id}` | [HongdalAdmin/Services/백오피스조회Service.cs](../../../../../HongdalAdmin/Services/백오피스조회Service.cs) | `PUT api/v1/dispatch/wait/{id:long}` [Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs](../../../../../Hongdal/Controllers/Admin/02_유입/배차대기Controller.cs) |
