# HongdalAdmin-P32-1 - 차량 관리

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P32-1.png" alt="HongdalAdmin-P32-1 화면 캡처" width="720">
...
- 화면 소스: [HongdalAdmin/Components/Pages/VehicleManagement.razor](../../../../../HongdalAdmin/Components/Pages/VehicleManagement.razor)
