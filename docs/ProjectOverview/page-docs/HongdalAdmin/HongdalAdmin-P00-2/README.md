# HongdalAdmin-P00-2 - 오류 화면

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P00-2.png" alt="HongdalAdmin-P00-2 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalAdmin |
| 페이지 ID / 제목 | HongdalAdmin-P00-2 - 오류 화면 |
| 라우트 | /Error |
| 소스 파일 | [HongdalAdmin/Components/Pages/Error.razor](../../../../../HongdalAdmin/Components/Pages/Error.razor) |
| 분류 | 시스템 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalAdmin-P00-1 - 관리자 로그인](../HongdalAdmin-P00-1/)
- 다음 화면: [HongdalAdmin-P16 - 운영 대시보드](../HongdalAdmin-P16/)
...
- 화면 소스: [HongdalAdmin/Components/Pages/Error.razor](../../../../../HongdalAdmin/Components/Pages/Error.razor)
