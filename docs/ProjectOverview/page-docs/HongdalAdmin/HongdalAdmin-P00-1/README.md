# HongdalAdmin-P00-1 - 관리자 로그인

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P00-1.png" alt="HongdalAdmin-P00-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalAdmin |
| 페이지 ID / 제목 | HongdalAdmin-P00-1 - 관리자 로그인 |
| 라우트 | /login |
| 소스 파일 | [HongdalAdmin/Components/Pages/AdminLogin.razor](../../../../../HongdalAdmin/Components/Pages/AdminLogin.razor) |
| 분류 | 시스템 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalAdmin-P00 - 관리자 홈](../HongdalAdmin-P00/)
- 다음 화면: [HongdalAdmin-P00-2 - 오류 화면](../HongdalAdmin-P00-2/)
- 상위 화면: [HongdalAdmin-P00 - 관리자 홈](../HongdalAdmin-P00/)
- 하위 화면: 없음
...
- 화면 소스: [HongdalAdmin/Components/Pages/AdminLogin.razor](../../../../../HongdalAdmin/Components/Pages/AdminLogin.razor)
- 클라이언트 서비스/계약: [HongdalAdmin/Services/관리자인증Service.cs](../../../../../HongdalAdmin/Services/관리자인증Service.cs), [HongdalAdmin/Services/관리자인증세션Service.cs](../../../../../HongdalAdmin/Services/관리자인증세션Service.cs)

| 구분 | 메서드 | API 경로 | 클라이언트/문서 근거 | 서버 근거 |
| --- | --- | --- | --- | --- |
| 클라이언트 서비스 | POST | `api/v1/auth/login` | [HongdalAdmin/Services/관리자인증Service.cs](../../../../../HongdalAdmin/Services/관리자인증Service.cs) | `POST api/v1/auth/login` [Hongdal/Controllers/Common/인증Controller.cs](../../../../../Hongdal/Controllers/Common/인증Controller.cs) |
