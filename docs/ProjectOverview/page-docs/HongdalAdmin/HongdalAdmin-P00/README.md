# HongdalAdmin-P00 - 관리자 홈

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P00.png" alt="HongdalAdmin-P00 화면 캡처" width="720">
...
- 화면 소스: [HongdalAdmin/Components/Pages/Home.razor](../../../../../HongdalAdmin/Components/Pages/Home.razor)
