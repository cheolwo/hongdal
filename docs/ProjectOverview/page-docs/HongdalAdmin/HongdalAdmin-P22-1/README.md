...
| 분류 | 필수 |
| 1.0 필수 연결 | [HongdalAdmin-P22-1](../../../hongdal-v1-required-pages.md) |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalAdmin-P22](../HongdalAdmin-P22/)
- 다음 화면: [HongdalAdmin-P22-2](../HongdalAdmin-P22-2/)
