# HongdalAdmin-P22-1 - 운송 이벤트 감사

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P22-1.png" alt="HongdalAdmin-P22-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalAdmin |
| 페이지 ID / 제목 | HongdalAdmin-P22-1 - 운송 이벤트 감사 |
| 라우트 | /transports/{RequestId}/events |
| 소스 파일 | [HongdalAdmin/Components/Pages/TransportWorkflowEvents.razor](../../../../../HongdalAdmin/Components/Pages/TransportWorkflowEvents.razor) |
| 분류 | 필수 |
| 1.0 필수 연결 | [HongdalAdmin-P22-1 - 운송 이벤트 감사](../../../hongdal-v1-required-pages.md) |
| 캡처 상태 | 완료 |
...
이 화면은 홍달 1.0 국내 화물 운송 워크플로우 안에서 운송 이벤트 감사 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [HongdalAdmin-P22 - 운송 상세 원장](../HongdalAdmin-P22/)
- 다음 화면: [HongdalAdmin-P22-2 - 운송 증빙/POD](../HongdalAdmin-P22-2/)
...
- 화면 소스: [HongdalAdmin/Components/Pages/TransportWorkflowEvents.razor](../../../../../HongdalAdmin/Components/Pages/TransportWorkflowEvents.razor)
