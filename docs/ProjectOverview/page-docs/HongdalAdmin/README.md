...
| [HongdalAdmin-P23 - 관리자 활동 로그](HongdalAdmin-P23/) | /activity-logs | 운영 | 관리자 활동 로그 | 완료 |
...
| [HongdalAdmin-P27 - 문서 목록](HongdalAdmin-P27/) | /documents | 필수 | 문서 목록 | 완료 |
| [HongdalAdmin-P27-1 - 문서 업로드](HongdalAdmin-P27-1/) | /documents/upload | 필수 | 문서 업로드 | 완료 |
| [HongdalAdmin-P27-2 - 문서 정책 목록](HongdalAdmin-P27-2/) | /documents/policies | 필수 | 문서 정책 목록 | 완료 |
| [HongdalAdmin-P27-3 - 문서 정책 상세](HongdalAdmin-P27-3/) | /documents/policies/{DocumentCode} | 필수 | 문서 정책 상세 | 완료 |
| [HongdalAdmin-P27-4 - 문서 조회 로그](HongdalAdmin-P27-4/) | /documents/logs | 필수 | 문서 조회 로그 | 완료 |
...
| [HongdalAdmin-P29 - HS 코드/통관 운영](HongdalAdmin-P29/) | /customs/hs-codes | 운영 | HS 코드/통관 운영 | 완료 |
| [HongdalAdmin-P30 - 음식 주문/배달 운영](HongdalAdmin-P30/) | /food/operations | 운영 | 음식 주문/배달 운영 | 완료 |
| [HongdalAdmin-P30-1 - 음식점 검색 정책](HongdalAdmin-P30-1/) | /restaurant-search-policy | 운영 | 음식점 검색 정책 | 완료 |
...
| [HongdalAdmin-P35 - 보조 기능 설정](HongdalAdmin-P35/) | /auxiliary-feature-settings | 운영 | 보조 기능 설정 | 완료 |
| [HongdalAdmin-P36 - 연락처 통합 검색](HongdalAdmin-P36/) | /contact-search | 운영 | 전화번호 뒤 8자리 기준 인물/역할 통합 조회 | 완료 |
