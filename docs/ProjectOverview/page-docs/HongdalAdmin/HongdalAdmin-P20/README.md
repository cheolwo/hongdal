# HongdalAdmin-P20 - 운행 중 기사 현황

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P20.png" alt="HongdalAdmin-P20 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalAdmin |
| 페이지 ID / 제목 | HongdalAdmin-P20 - 운행 중 기사 현황 |
| 라우트 | /drivers/operating |
| 소스 파일 | [HongdalAdmin/Components/Pages/DriverOperatingView.razor](../../../../../HongdalAdmin/Components/Pages/DriverOperatingView.razor) |
| 분류 | 필수 |
| 1.0 필수 연결 | [HongdalAdmin-P20 - 운행 중 기사 현황](../../../hongdal-v1-required-pages.md) |
| 캡처 상태 | 완료 |

## 왜 필요한가

이 화면은 운행 중 기사 현황을 담당하므로, 1.0 업무 흐름이 실제 사용자 행동으로 닫히기 위해 필요합니다.

## 사용자와 참여자

주 사용자: 관리자, 운영자 / 보조 참여자: 화주, 기사, 파트너, 문서 담당자

이 화면은 홍달 1.0 국내 화물 운송 워크플로우 안에서 운행 중 기사 현황 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [HongdalAdmin-P19 - 배차대기/추천 잠금 상태](../HongdalAdmin-P19/)
- 다음 화면: [HongdalAdmin-P21 - 운송 목록](../HongdalAdmin-P21/)
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [HongdalAdmin/Components/Pages/DriverOperatingView.razor](../../../../../HongdalAdmin/Components/Pages/DriverOperatingView.razor)
- 클라이언트 서비스/계약: 화면 파일에서 직접 확인하거나 정적/라우팅 화면으로 본다.

| 구분 | 메서드 | API 경로 | 클라이언트/문서 근거 | 서버 근거 |
| --- | --- | --- | --- | --- |
| 1.0 문서 | - | `api/v1/admin/drivers/operating` | [docs/ProjectOverview/hongdal-v1-required-pages.md](../../../hongdal-v1-required-pages.md) | ``GET api/v1/admin/drivers/operating`` [Hongdal/Controllers/Admin/03_진행/기사운행현황Controller.cs](../../../../../Hongdal/Controllers/Admin/03_진행/기사운행현황Controller.cs)<br>``GET api/v1/admin/drivers`` [Hongdal/Controllers/Admin/06_관리/기사관리Controller.cs](../../../../../Hongdal/Controllers/Admin/06_관리/기사관리Controller.cs) |
