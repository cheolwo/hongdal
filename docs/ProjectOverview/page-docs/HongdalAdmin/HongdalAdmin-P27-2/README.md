...
| 분류 | 필수 |
| 1.0 필수 연결 | [HongdalAdmin-P27-2](../../../hongdal-v1-required-pages.md) |
| 캡처 상태 | 인증 필요 |
...
- 이전 화면: [HongdalAdmin-P27-1](../HongdalAdmin-P27-1/)
- 다음 화면: [HongdalAdmin-P27-3](../HongdalAdmin-P27-3/)
