# HongdalAdmin-P32 - 기사 목록/관리

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P32.png" alt="HongdalAdmin-P32 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalAdmin |
| 페이지 ID / 제목 | HongdalAdmin-P32 - 기사 목록/관리 |
| 라우트 | /drivers |
| 소스 파일 | [HongdalAdmin/Components/Pages/Drivers.razor](../../../../../HongdalAdmin/Components/Pages/Drivers.razor) |
| 분류 | 운영 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [HongdalAdmin-P31 - 탐색 캠페인 운영](../HongdalAdmin-P31/)
- 다음 화면: [HongdalAdmin-P32-1 - 차량 관리](../HongdalAdmin-P32-1/)
- 상위 화면: 없음
- 하위 화면: [HongdalAdmin-P32-1 - 차량 관리](../HongdalAdmin-P32-1/)

상호작용 관점에서는 다음 흐름을 우선 봅니다. 관리자는 여러 앱에서 발생한 상태 변경을 모아 보고, 막힌 배차·증빙·정산·문서 문제에 개입합니다.

## API 경로와 코드 연결

- 화면 소스: [HongdalAdmin/Components/Pages/Drivers.razor](../../../../../HongdalAdmin/Components/Pages/Drivers.razor)
