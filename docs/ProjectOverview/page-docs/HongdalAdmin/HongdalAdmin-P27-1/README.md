# HongdalAdmin-P27-1 - 문서 업로드

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P27-1.png" alt="HongdalAdmin-P27-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | HongdalAdmin |
| 페이지 ID / 제목 | HongdalAdmin-P27-1 - 문서 업로드 |
| 라우트 | /documents/upload |
| 소스 파일 | [HongdalAdmin/Components/Pages/DocumentUpload.razor](../../../../../HongdalAdmin/Components/Pages/DocumentUpload.razor) |
| 분류 | 필수 |
| 1.0 필수 연결 | [HongdalAdmin-P27-1 - 문서 업로드](../../../hongdal-v1-required-pages.md) |
| 캡처 상태 | 완료 |
...
이 화면은 홍달 1.0 국내 화물 운송 워크플로우 안에서 문서 업로드 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [HongdalAdmin-P27 - 문서 목록](../HongdalAdmin-P27/)
- 다음 화면: [HongdalAdmin-P27-2 - 문서 정책 목록](../HongdalAdmin-P27-2/)
...
- 화면 소스: [HongdalAdmin/Components/Pages/DocumentUpload.razor](../../../../../HongdalAdmin/Components/Pages/DocumentUpload.razor)
