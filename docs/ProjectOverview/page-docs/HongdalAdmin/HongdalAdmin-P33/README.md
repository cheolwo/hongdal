# HongdalAdmin-P33 - 파트너 관리

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P33.png" alt="HongdalAdmin-P33 화면 캡처" width="720">
...
- 화면 소스: [HongdalAdmin/Components/Pages/Partners.razor](../../../../../HongdalAdmin/Components/Pages/Partners.razor)
...
| --- | --- | --- | --- | --- |
| 클라이언트 서비스 | - | `api/v1/admin/partners/companies` | [HongdalAdmin/Services/백오피스조회Service.cs](../../../../../HongdalAdmin/Services/백오피스조회Service.cs) | `GET api/v1/admin/partners/companies` [Hongdal/Controllers/Admin/06_관리/업체화주관리Controller.cs](../../../../../Hongdal/Controllers/Admin/06_관리/업체화주관리Controller.cs) |
| 클라이언트 서비스 | - | `api/v1/admin/partners/shippers` | [HongdalAdmin/Services/백오피스조회Service.cs](../../../../../HongdalAdmin/Services/백오피스조회Service.cs) | `GET api/v1/admin/partners/shippers` [Hongdal/Controllers/Admin/06_관리/업체화주관리Controller.cs](../../../../../Hongdal/Controllers/Admin/06_관리/업체화주관리Controller.cs) |
