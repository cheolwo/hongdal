# HongdalAdmin-P28 - 공개 화물/화물 운영 화면

[전체 화면 문서](../../README.md) / [HongdalAdmin 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/HongdalAdmin/HongdalAdmin-P28.png" alt="HongdalAdmin-P28 화면 캡처" width="720">
...
- 화면 소스: [HongdalAdmin/Components/Pages/PublicCargo.razor](../../../../../HongdalAdmin/Components/Pages/PublicCargo.razor)
