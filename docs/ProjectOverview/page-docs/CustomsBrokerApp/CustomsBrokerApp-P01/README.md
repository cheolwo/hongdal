# CustomsBrokerApp-P01 - 관세사/통관 담당자 홈

[전체 화면 문서](../../README.md) / [CustomsBrokerApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/CustomsBrokerApp/CustomsBrokerApp-P01.png" alt="CustomsBrokerApp-P01 화면 캡처" width="720">
...
이 화면은 관세사/통관 담당자 홈을 담당하므로, 1.0 이후의 해외 물류, 창고, 주문자 집단, 판매채널 확장을 화면 단위로 검증하기 위해 필요합니다.

## 사용자와 참여자

주 사용자: 관세사, 통관 담당자 / 보조 참여자: 화주, 관리자, 주문자 집단

이 화면은 해외 물류/통관 확장 워크플로우 안에서 관세사/통관 담당자 홈 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
상호작용 관점에서는 다음 흐름을 우선 봅니다. 통관 담당자의 HS 코드·위험 태그 판단은 화주/주문자 집단의 수입 비용 및 통관 상태 판단에 반영될 수 있습니다.

## API 경로와 코드 연결

- 화면 소스: [CustomsBrokerApp/Pages/Home.razor](../../../../../CustomsBrokerApp/Pages/Home.razor)
- 클라이언트 서비스/계약: [CustomsBrokerApp/Services/CustomsBrokerAuthService.cs](../../../../../CustomsBrokerApp/Services/CustomsBrokerAuthService.cs), [CustomsBrokerApp/Services/HsCodeCorrectionService.cs](../../../../../CustomsBrokerApp/Services/HsCodeCorrectionService.cs)
...
추가 API 후보 10개는 관련 서비스 파일에서 계속 확인합니다. 이 화면 README는 화면 책임 판단에 필요한 대표 경로만 먼저 노출합니다.
