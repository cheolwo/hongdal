# SsalddelApp-P10 - 꾸미기 상점

[전체 화면 문서](../../README.md) / [SsalddelApp 화면 목록](../README.md) / [통합 클라이언트 가이드](../../../unified-community-client.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelApp/SsalddelApp-P10.png" alt="SsalddelApp-P10 꾸미기 상점" width="720">
...
| 소스 | [CommunityDecorationStorePage.razor](../../../../../SsalddelApp/Components/Pages/CommunityDecorationStorePage.razor) |
| 분류 | 확장 |
...
- 상품 선택: [SsalddelApp-P10-1](../SsalddelApp-P10-1/)
- 직접 만들기: [SsalddelApp-P10-3](../SsalddelApp-P10-3/)
- 디자이너 테마 패키지 등록: [SsalddelApp-P10-4](../SsalddelApp-P10-4/)
- 돌아가기: [SsalddelApp-P00](../SsalddelApp-P00/)
