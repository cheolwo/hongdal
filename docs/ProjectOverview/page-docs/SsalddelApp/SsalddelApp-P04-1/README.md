# SsalddelApp-P04-1 - 입고 요청 목록과 처리

[전체 화면 문서](../../README.md) / [SsalddelApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelApp/SsalddelApp-P04-1.png" alt="SsalddelApp-P04-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelApp |
| 페이지 ID / 제목 | SsalddelApp-P04-1 - 입고 요청 목록과 처리 |
| 라우트 | /shipper/inbound/requests |
| 소스 파일 | [SsalddelApp/Components/Pages/InboundRequests.razor](../../../../../SsalddelApp/Components/Pages/InboundRequests.razor) |
| 분류 | 확장 |
...
이 화면은 입고 요청 목록과 처리을 담당하므로, 1.0 이후의 해외 물류, 창고, 주문자 집단, 판매채널 확장을 화면 단위로 검증하기 위해 필요합니다.

## 사용자와 참여자

주 사용자: 화주, 판매자, 물류 의뢰자 / 보조 참여자: 기사, 관리자, 창고 관리자

이 화면은 창고/출고/피킹 확장 워크플로우 안에서 입고 요청 목록과 처리 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [SsalddelApp-P04 - 화주 입고 업무 대시보드](../SsalddelApp-P04/)
- 다음 화면: [SsalddelApp-P05 - 화주 관점 창고 업무 허브](../SsalddelApp-P05/)
- 상위 화면: [SsalddelApp-P04 - 화주 입고 업무 대시보드](../SsalddelApp-P04/)
- 하위 화면: 없음
...
- 화면 소스: [SsalddelApp/Components/Pages/InboundRequests.razor](../../../../../SsalddelApp/Components/Pages/InboundRequests.razor)
