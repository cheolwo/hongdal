# SsalddelApp-P06-1 - 상품 등록/리스팅

[전체 화면 문서](../../README.md) / [SsalddelApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelApp/SsalddelApp-P06-1.png" alt="SsalddelApp-P06-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelApp |
| 페이지 ID / 제목 | SsalddelApp-P06-1 - 상품 등록/리스팅 |
| 라우트 | /shipper/sales/listings |
| 소스 파일 | [SsalddelApp/Components/Pages/ProductListings.razor](../../../../../SsalddelApp/Components/Pages/ProductListings.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [SsalddelApp-P06 - 판매채널 연결/관리](../SsalddelApp-P06/)
- 다음 화면: [SsalddelApp-P06-2 - 판매 주문 이행/출고 연결](../SsalddelApp-P06-2/)
...
- 화면 소스: [SsalddelApp/Components/Pages/ProductListings.razor](../../../../../SsalddelApp/Components/Pages/ProductListings.razor)
