...
| 소스 | [CommunityDecorationCreatePage.razor](../../../../../SsalddelApp/Components/Pages/CommunityDecorationCreatePage.razor) |
| 분류 | 확장 |
| 캡처 | 대기 |
...
- 저장 성공: 생성된 [SsalddelApp-P10-1 상세](../SsalddelApp-P10-1/) 경로
