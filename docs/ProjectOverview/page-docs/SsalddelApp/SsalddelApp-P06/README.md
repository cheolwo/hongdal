# SsalddelApp-P06 - 판매채널 연결/관리

[전체 화면 문서](../../README.md) / [SsalddelApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelApp/SsalddelApp-P06.png" alt="SsalddelApp-P06 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelApp |
| 페이지 ID / 제목 | SsalddelApp-P06 - 판매채널 연결/관리 |
| 라우트 | /shipper/sales/channels |
| 소스 파일 | [SsalddelApp/Components/Pages/SalesChannels.razor](../../../../../SsalddelApp/Components/Pages/SalesChannels.razor) |
| 분류 | 확장 |
...
- 이전 화면: [SsalddelApp-P05-3 - 창고 프로세스별 작업 시작](../SsalddelApp-P05-3/)
- 다음 화면: [SsalddelApp-P06-1 - 상품 등록/리스팅](../SsalddelApp-P06-1/)
- 상위 화면: 없음
- 하위 화면: [SsalddelApp-P06-1 - 상품 등록/리스팅](../SsalddelApp-P06-1/), [SsalddelApp-P06-2 - 판매 주문 이행/출고 연결](../SsalddelApp-P06-2/)

상호작용 관점에서는 다음 흐름을 우선 봅니다. 화주가 입력하거나 확인한 의뢰/결제/창고 상태는 기사 앱의 추천, 관리자 원장, 창고 작업 화면으로 이어질 수 있습니다.

## API 경로와 코드 연결

- 화면 소스: [SsalddelApp/Components/Pages/SalesChannels.razor](../../../../../SsalddelApp/Components/Pages/SalesChannels.razor)
- 클라이언트 서비스/계약: [SsalddelApp/Services/IShipperSalesService.cs](../../../../../SsalddelApp/Services/IShipperSalesService.cs), [SsalddelApp/Services/ShipperSalesService.cs](../../../../../SsalddelApp/Services/ShipperSalesService.cs)
