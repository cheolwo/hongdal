# SsalddelApp-P10-2-1 - 홈 테마 구매 완료와 적용 선택

[전체 화면 문서](../../README.md) / [SsalddelApp 화면 목록](../README.md) / [통합 클라이언트 가이드](../../../unified-community-client.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelApp/SsalddelApp-P10-2-1.png" alt="SsalddelApp-P10-2-1 홈 테마 FakePG 구매 완료와 적용 선택" width="720">
...
- 이전: [SsalddelApp-P10-2 FakePG 결제](../SsalddelApp-P10-2/)
- 상품 상세: [SsalddelApp-P10-1](../SsalddelApp-P10-1/)
