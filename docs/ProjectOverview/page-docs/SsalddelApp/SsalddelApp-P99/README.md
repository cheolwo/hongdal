# SsalddelApp-P99 - 미발견 페이지

[전체 화면 문서](../../README.md) / [SsalddelApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelApp/SsalddelApp-P99.png" alt="SsalddelApp-P99 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelApp |
| 페이지 ID / 제목 | SsalddelApp-P99 - 미발견 페이지 |
| 라우트 | /not-found |
| 소스 파일 | [SsalddelApp/Components/Pages/NotFound.razor](../../../../../SsalddelApp/Components/Pages/NotFound.razor) |
| 분류 | 시스템 |
...
- 이전 화면: [SsalddelApp-P91 - 템플릿/샘플성 카운터 화면](../SsalddelApp-P91/)
- 다음 화면: 없음
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [SsalddelApp/Components/Pages/NotFound.razor](../../../../../SsalddelApp/Components/Pages/NotFound.razor)
