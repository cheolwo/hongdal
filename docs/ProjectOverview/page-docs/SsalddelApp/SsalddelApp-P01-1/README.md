# SsalddelApp-P01-1 - 화주 프로필과 운영 프로필 설정

[전체 화면 문서](../../README.md) / [SsalddelApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelApp/SsalddelApp-P01-1.png" alt="SsalddelApp-P01-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelApp |
| 페이지 ID / 제목 | SsalddelApp-P01-1 - 화주 프로필과 운영 프로필 설정 |
| 라우트 | /shipper/settings/profile |
| 소스 파일 | [SsalddelApp/Components/Pages/ShipperProfileSettings.razor](../../../../../SsalddelApp/Components/Pages/ShipperProfileSettings.razor) |
| 분류 | 보조 |
...
- 이전 화면: [SsalddelApp-P01 - 화주 업무 홈, 운송 의뢰/상태/창고/판매 업무 진입](../SsalddelApp-P01/)
- 다음 화면: [SsalddelApp-P01-2 - 화주 앱 메뉴/화면 노출 설정](../SsalddelApp-P01-2/)
...
- 화면 소스: [SsalddelApp/Components/Pages/ShipperProfileSettings.razor](../../../../../SsalddelApp/Components/Pages/ShipperProfileSettings.razor)
- 클라이언트 서비스/계약: [SsalddelApp/Services/Localization/ShipperLocalizationService.cs](../../../../../SsalddelApp/Services/Localization/ShipperLocalizationService.cs), [SsalddelApp/Services/ShipperOperatingProfileService.cs](../../../../../SsalddelApp/Services/ShipperOperatingProfileService.cs)
