...
<img src="../../../assets/app-pages/SsalddelApp/SsalddelApp-P02-1.png" alt="SsalddelApp-P02-1 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelApp |
| 페이지 ID / 제목 | SsalddelApp-P02-1 - 운송 의뢰 대량 등록 |
| 라우트 | /shipper/request/bulk |
| 소스 파일 | [SsalddelApp/Components/Pages/ShipperBulkImport.razor](../../../../../SsalddelApp/Components/Pages/ShipperBulkImport.razor) |
| 분류 | 보조 |
| 2.0 운송 필수 연결 | [SsalddelApp-P02-1 - 운송 의뢰 대량 등록](../../../ssalddel-v1-required-pages.md) |
| 캡처 상태 | 완료 |
...
이 화면은 살뜰 2.0 국내 화물 운송 워크플로우 안에서 운송 의뢰 대량 등록 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [SsalddelApp-P02 - 운송 의뢰 작성](../SsalddelApp-P02/)
- 다음 화면: [SsalddelApp-P02-2 - 배차 주소 입력/검증 폼](../SsalddelApp-P02-2/)
- 상위 화면: [SsalddelApp-P02 - 운송 의뢰 작성](../SsalddelApp-P02/)
- 하위 화면: 없음
...
- 화면 소스: [SsalddelApp/Components/Pages/ShipperBulkImport.razor](../../../../../SsalddelApp/Components/Pages/ShipperBulkImport.razor)
