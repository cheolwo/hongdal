# SsalddelApp-P91 - 템플릿/샘플성 카운터 화면

[전체 화면 문서](../../README.md) / [SsalddelApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/SsalddelApp/SsalddelApp-P91.png" alt="SsalddelApp-P91 화면 캡처" width="720">
...
| --- | --- |
| 앱 | SsalddelApp |
| 페이지 ID / 제목 | SsalddelApp-P91 - 템플릿/샘플성 카운터 화면 |
| 라우트 | /counter |
| 소스 파일 | [SsalddelApp/Components/Pages/Counter.razor](../../../../../SsalddelApp/Components/Pages/Counter.razor) |
| 분류 | 시스템 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [SsalddelApp-P90 - 템플릿/샘플성 날씨 화면](../SsalddelApp-P90/)
- 다음 화면: [SsalddelApp-P99 - 미발견 페이지](../SsalddelApp-P99/)
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [SsalddelApp/Components/Pages/Counter.razor](../../../../../SsalddelApp/Components/Pages/Counter.razor)
