# OrdererApp-P99 - 미발견 페이지

[전체 화면 문서](../../README.md) / [OrdererApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/OrdererApp/OrdererApp-P99.png" alt="OrdererApp-P99 화면 캡처" width="720">
...
| --- | --- |
| 앱 | OrdererApp |
| 페이지 ID / 제목 | OrdererApp-P99 - 미발견 페이지 |
| 라우트 | /not-found |
| 소스 파일 | [OrdererApp/Components/Pages/NotFound.razor](../../../../../OrdererApp/Components/Pages/NotFound.razor) |
| 분류 | 시스템 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
- 이전 화면: [OrdererApp-P05 - 주문 이력](../OrdererApp-P05/)
- 다음 화면: 없음
- 상위 화면: 없음
- 하위 화면: 없음
...
- 화면 소스: [OrdererApp/Components/Pages/NotFound.razor](../../../../../OrdererApp/Components/Pages/NotFound.razor)
