# OrdererApp-P04-2 - 마트 주문

[전체 화면 문서](../../README.md) / [OrdererApp 화면 목록](../README.md) / [앱 전체 카탈로그](../../../app-page-catalog.md)

## 화면 캡처

<img src="../../../assets/app-pages/OrdererApp/OrdererApp-P04-2.png" alt="OrdererApp-P04-2 화면 캡처" width="720">
...
| --- | --- |
| 앱 | OrdererApp |
| 페이지 ID | OrdererApp-P04-2 |
| 라우트 | /food/mart |
| 소스 파일 | [OrdererApp/Components/Pages/MartOrder.razor](../../../../../OrdererApp/Components/Pages/MartOrder.razor) |
| 분류 | 확장 |
| 1.0 필수 연결 | 직접 연결 없음 |
| 캡처 상태 | 완료 |
...
이 화면은 마트 주문을 담당하므로, 1.0 이후의 해외 물류, 창고, 주문자 집단, 판매채널 확장을 화면 단위로 검증하기 위해 필요합니다.

## 사용자와 참여자

주 사용자: 주문자, 공동구매 참여자 / 보조 참여자: 집단 운영자, 화주 역할 대행자, 관리자

이 화면은 창고/출고/피킹 확장 워크플로우 안에서 마트 주문 책임을 갖습니다. 화면 하나가 너무 많은 결정을 떠안지 않도록, 이 문서에서는 이 화면의 주 책임과 다른 화면으로 넘겨야 할 책임을 구분해 관리합니다.
...
- 이전 화면: [OrdererApp-P04-1](../OrdererApp-P04-1/)
- 다음 화면: [OrdererApp-P05](../OrdererApp-P05/)
...
- 화면 소스: [OrdererApp/Components/Pages/MartOrder.razor](../../../../../OrdererApp/Components/Pages/MartOrder.razor)
