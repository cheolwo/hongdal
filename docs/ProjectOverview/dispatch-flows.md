...
운송 의뢰 배차 엔진은 기사에게 맡길 실제 이동 업무를 통합해서 보는 서버 판단 계층입니다. 화주 운송 의뢰, 창고 출고품, 알뜰살뜰 마트 출고, 음식점 주문은 화면과 원장은 다를 수 있지만, 기사 추천 단계에서는 `배차대기.원본의뢰유형`과 `배차업무유형`으로 분류한 뒤 같은 배차 큐 흐름을 탑니다.
