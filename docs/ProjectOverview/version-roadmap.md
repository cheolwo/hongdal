...
현재 집중 대상은 문화교통 `0.0`입니다. 공개 정보와 대화, 참여 동의, 공동 원장, 완료 사례와 안전·운영 폐쇄 루프를 먼저 안정화합니다. 세부 구현 우선순위는 [0.0 집중 로드맵](../Versions/v0.0/focus-roadmap.md)을 따릅니다.
...
| `0.5` | 개별주문·개별 원장 | 본인 소유 주문 의향, 등록·변경·철회, 공동 참여 동의 분리 | 자동집단화·결제·계약·배송 |
| `1.0` | 공동주문·주문자 집단화 | 동의한 개별주문, 품목·지역·수령 조건별 집단, 모집·협의 | 결제·계약·신고·자동 배차 |
