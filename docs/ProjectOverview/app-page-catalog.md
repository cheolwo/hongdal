...
| `WarehouseManagerApp-P04 - 피킹 작업` | `/work/picking-batch` | `WarehouseManagerApp/Components/Pages/PickingBatchWorkspace.razor` | 확장 | 서버 피킹 목록·정확한 상세·시작/완료·같은 Key 재조회 | - | 실제 캡처<br><img src="../assets/changes/2026-07-20-warehouse-picking-task/desktop.png" alt="WarehouseManagerApp-P04" width="160"> |
