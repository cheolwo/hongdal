...
- 기획 ID: `PLAN-GRAPH-NORTHERN-LIFE-001`
- 기획 분야: `Graph Map / 북부 생활권`
- 기획 판본: `northern-life-hub-discovery-graph-map-proposal.r4`
- 상태: `ApprovedForHandoff`
- 상위 기획: `PLAN-WORLD-FOUR-AREAS-001`
- 관련 하위 기획: `PLAN-GRAPH-NORTHERN-LIFE-REVIEW-001`, `PLAN-GRAPH-PLANNING-INTEGRATION-001`
- 관련 결정·기준: [Graph Map 기획 인계 순환 체계](../Architecture/GraphMap기획인계순환체계.md), 현행 [기획 목차](PLANNING.md)
- 관련 WI·PlayableLoop: 기존 북부 생활권 노드에 결속된 WI만 재사용하며 최신 기획의 새 WI는 자동 생성하지 않음
- Graph Map 영향: `UpdateExisting` / `Federation`, `Level1`, `Level2`, `Level3`
- 다음 질문 또는 인계 상태: 현행 기획 hash와 기존 Graph Map r6 이후 판본을 다시 대조해 stale 결속을 명시적으로 갱신
