...
| `evidence:nature-shelter-playmode-20260825` Nature 생활거점 실제 입력 E7 후보 | UnityPlayMode | Partial/Current | E5, E6, E7 | 실제 Input System으로 도끼 획득, 벌목 취소·재시도, 세 나무 벌목, 오두막 배치·건설, 입장·퇴장, HUD 저장과 Scene 재진입 복원을 자동 PlayMode 1/1로 검증했다. 고유 Editor에서 `Nature 탐험` 진입과 중앙 조준 도끼 획득을 실제 입력하고 Game View PNG를 저장했으며 canonical Scene Missing Script는 0개다. 기존 10개 경고는 Test Runner 임시 백업 Scene으로 분리했다. | 사람이 도끼 획득부터 저장 복원까지 전 과정을 수동 완주한 증거 / 실제 음향 청취와 승인 Nature Ambient·BGM / 운영 Provider와 운영 DB |
