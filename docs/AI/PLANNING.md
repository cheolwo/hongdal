...
| `PLAN-PLANNING-PLAYER-CONTEXT-001` | [시간·공간·플레이어·대상 WI 기획 r4](시간공간플레이어대상-WI기획정리-2026-08-31.md) | `ApprovedPlanningBaseline / ActionDescriptionOnly` | 지금·여기·나·너와 구체적인 행동·방법을 기록하고 선택·대가·대안·실제 결과를 구분하는 문답 기준 |
