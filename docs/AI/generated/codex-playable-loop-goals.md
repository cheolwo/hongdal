...
| --- | --- | --- | --- | --- |
| `WI-NATURE-05` 벌목 도끼 확보 | E6 → E7 | evidence:simulation-task-20260824<br>evidence:nature-r2-core-20260825<br>evidence:nature-shelter-playmode-20260825<br>evidence:nature-shelter-hosted-parity-20260825 | 자동 실제 입력 전체 폐루프와 외부 RemoteHost 동등성은 통과했지만 사람의 전체 수동 완주·실제 청음·재로드 직렬화 경고 분리가 남아 있다. | `WI-NATURE-05` |
