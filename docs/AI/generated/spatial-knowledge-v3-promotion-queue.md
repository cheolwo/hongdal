...
| 3 | `H1` | `h1-expression:farm:농산물-집하-직판장` | 행동 H1과 능력·용량·연결구 검토 |
| 4 | `H1` | `h1-expression:city:상하차-dock` | 행동 H1과 능력·용량·연결구 검토 |
| 5 | `H1` | `h1-expression:nature:산길-바위-길목` | 행동 H1과 능력·용량·연결구 검토 |
| 6 | `H1` | `h1-expression:nature:숲-가장자리` | 행동 H1과 능력·용량·연결구 검토 |
| 7 | `H1` | `h1-expression:city:물류-station-진입부` | 행동 H1과 능력·용량·연결구 검토 |
| 8 | `H1` | `h1-expression:farm:시설하우스-단동` | 행동 H1과 능력·용량·연결구 검토 |
| 9 | `H1` | `h1-expression:nature:숲-빈터-고사목` | 행동 H1과 능력·용량·연결구 검토 |
| 10 | `H1` | `h1-expression:town:읍내-상점-전면` | 행동 H1과 능력·용량·연결구 검토 |
