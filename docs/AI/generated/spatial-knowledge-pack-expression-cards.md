...
| `City` | `h1-expression:city:도심-마트-앞마당` 도심 마트 앞마당 — City 단독 표현 | city:도심 마트 앞마당:A, city:도심 마트 앞마당:B, city:도심 마트 앞마당:C | h1-stock:town-contamination-inspection, h1-stock:town-market-receiving, h1-stock:town-returns |
| `City` | `h1-expression:city:먹거리-상점-골목` 먹거리 상점 골목 — City 단독 표현 | city:먹거리 상점 골목:A, city:먹거리 상점 골목:B, city:먹거리 상점 골목:C | h1-stock:town-market-display, h1-stock:town-order-packing |
...
| `City` | `h1-expression:city:상하차-dock` 상하차 Dock — City 단독 표현 | city:상하차 Dock:A, city:상하차 Dock:B, city:상하차 Dock:C | h1-stock:hub-outbound-staging, h1-stock:hub-quarantine, h1-stock:hub-receiving-storage, h1-stock:hub-returns, h1-stock:hub-temporary-staging, h1-stock:hub-vehicle-yard, h1-stock:town-contamination-quarantine |
| `City` | `h1-expression:city:화물-대기-야드` 화물 대기 야드 — City 단독 표현 | city:화물 대기 야드:A, city:화물 대기 야드:B, city:화물 대기 야드:C | h1-stock:hub-cold-storage, h1-stock:hub-long-term-storage, h1-stock:hub-outbound-staging, h1-stock:hub-quarantine, h1-stock:hub-receiving-storage, h1-stock:hub-returns, h1-stock:hub-service-maintenance, h1-stock:hub-temporary-staging, h1-stock:hub-vehicle-yard, h1-stock:town-cleanup-transfer |
...
| `Town` | `h1-expression:town:버스-정류장-보행-쉼터` 버스 정류장·보행 쉼터 — Town 단독 표현 | town:버스 정류장·보행 쉼터:A, town:버스 정류장·보행 쉼터:B, town:버스 정류장·보행 쉼터:C | h1-stock:farm-worker-waiting, h1-stock:town-nature-relief, h1-stock:town-resident-pickup |
| `Town` | `h1-expression:town:생활-공공광장` 생활 공공광장 — Town 단독 표현 | town:생활 공공광장:A, town:생활 공공광장:B, town:생활 공공광장:C | h1-stock:town-living-square, h1-stock:town-nature-relief, h1-stock:town-neighborhood-service, h1-stock:town-recall-service, h1-stock:town-staff-rest |
| `Town` | `h1-expression:town:읍내-상점-전면` 읍내 상점 전면 — Town 단독 표현 | town:읍내 상점 전면:A, town:읍내 상점 전면:B, town:읍내 상점 전면:C | h1-stock:town-contamination-inspection, h1-stock:town-contamination-quarantine, h1-stock:town-market-display, h1-stock:town-neighborhood-service, h1-stock:town-order-packing, h1-stock:town-recall-service, h1-stock:town-resident-pickup, h1-stock:town-returns |
| `Town` | `h1-expression:town:저층-주택-블록` 저층 주택 블록 — Town 단독 표현 | town:저층 주택 블록:A, town:저층 주택 블록:B, town:저층 주택 블록:C | h1-stock:farm-residential-home |
| `Town` | `h1-expression:town:정원-담장-경계` 정원·담장 경계 — Town 단독 표현 | town:정원·담장 경계:A, town:정원·담장 경계:B, town:정원·담장 경계:C | h1-stock:town-cleanup-transfer, h1-stock:town-waste |
