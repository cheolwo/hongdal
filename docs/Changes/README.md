...
| 날짜 | 기록 | 주요 화면 변화 |
| --- | --- | --- |
| 2026-07-27 | [FDriver 추천 응답성과 주소 공개 경계](2026-07-27-fdriver-recommendation-ux.md) | 간접 확인 — 운행 중 15초 업무 갱신·2분 위치 전송, 추천 만료 카운트다운·거절, 다건 진행 배달 선택, 자동 배차 비활성 안내와 수락 전 고객 주소·좌표 축약을 연결 |
