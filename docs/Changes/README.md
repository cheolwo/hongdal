...
| 날짜 | 기록 | 주요 화면 변화 |
| --- | --- | --- |
| 2026-07-24 | [0.0~3.5 간괘 게시판 산맥 확정](2026-07-24-community-board-mountains.md) | 간접 확인 — Command/Event별 활동 게시판을 버전별 일곱 산으로 통합하고 각 카드에서 관련 Command·Event·페이지를 펼쳐 점검하도록 구성, 간괘 `☶` 적용 |
