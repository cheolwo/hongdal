...
- 서버 운영 국가를 공동구매 거래경로, 투표와 같이 수입 원장 메타데이터에 보존한다.
- 미국 운영 서버에서는 중국 공장 출발·미국 배송을 같이 수입 예시로 조립한다.
...
![미국 구매자 같이 수입 11단계와 중국 공장 전처리 데스크톱 화면](../assets/changes/2026-07-18-us-buyer-collective-import/desktop.png)

### 모바일

![미국 구매자 같이 수입 배송 여정 모바일 화면](../assets/changes/2026-07-18-us-buyer-collective-import/mobile.png)
