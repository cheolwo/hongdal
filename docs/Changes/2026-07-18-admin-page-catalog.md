...
- `HongdalAdminApp`의 `/page-catalog`에서 Admin, 커뮤니티, 음식점, 창고, 기사, 주문자 앱의 핵심 route 37개를 관리한다.
...
- 카탈로그 변경은 route 선언, 배포, 기능 플래그 또는 `HongdalExecution:Mode`를 직접 변경하지 않는다.
...
- `Hongdal.Tests` 전체 테스트 1,421개 통과
- `HongdalAdminApp` Windows 빌드 통과, 경고 0개·오류 0개
