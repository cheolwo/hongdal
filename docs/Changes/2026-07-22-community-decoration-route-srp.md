...
- 전역 Web 모바일 머리말의 제목 줄바꿈과 언어 전환 48px 터치 영역은 후속 `P2-2` 화주 홈 셸 감사에서 보완했다.
...
`P2-2`에서 Web과 모바일의 `/shipper`를 같은 공용 화주 허브 Screen으로 정렬하고, 공통 Web 모바일 머리말의 제목 줄바꿈과 언어 전환 터치 영역을 함께 보완했다.
