...
버전 선택은 기존 `살뜰 0.0`부터 `다음 서원`까지 유지한다. 템플릿은 선택한 버전의 초점, 이어받는 기반과 운영 경계를 본문에 포함한다.
...
- `Ssalddel.Tests` 전체 1,498개 통과
- `SsalddelAdminApp` `net10.0-windows10.0.19041.0` Release 빌드 경고 0개·오류 0개
