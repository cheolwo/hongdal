        ...
        : ICargoWarehouseHandoffApiClient
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return Task.FromResult<CargoWarehouseHandoffApiModel?>(
                new CargoWarehouseHandoffApiModel
                {
                    ...
                    TransportTaskStableId = "simulation-task:transport-71",
                    InboundTaskStableId = "simulation-task:inbound-91",
                    Movements = new[]
                    {
                        Movement(
                            ...
                            generatedAt),
                        Movement(
                            "npc-movement:inbound-worker.transport-71.inbound-91",
                            "npc:warehouse-inbound-worker.91",
                            "WarehouseInboundWorker",
                            "warehouse-inbound-worker-handoff",
                            "warehouse.staff-entry",
                            "unload-cargo",
                            "inbound-task:91",
                            generatedAt),
                    },
            ...
            DateTimeOffset generatedAt)
        {
            return new NpcMovementApiModel
            {
                ...
                WorldZoneCode = WorldZoneCodes.Warehouse,
                RouteCode = routeCode,
