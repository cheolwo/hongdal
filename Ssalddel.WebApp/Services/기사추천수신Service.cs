...
public sealed class 기사추천수신Service : I기사추천수신Service
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        _ledgerObserver.Observe(
            new TransportRequestLedgerSnapshot(
                ...
                "Ssalddel.WebApp.DriverAccepted"),
            "Ssalddel.WebApp.DriverAccepted");
        _ledgerObserver.RequestRefresh(requestId, "Ssalddel.WebApp.DriverAccepted");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        _ledgerObserver.RequestRefresh(requestId, "Ssalddel.WebApp.DriverRejected");
    ...
    private void Observe(기사추천수신항목 item)
    {
        ...
        _ledgerObserver.Observe(
            new TransportRequestLedgerSnapshot(
                ...
                null,
                DateTimeOffset.UtcNow,
                "Ssalddel.WebApp.DriverRecommendation"),
            "Ssalddel.WebApp.DriverRecommendation");
    }
