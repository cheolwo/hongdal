...
public sealed class 주문자Api기능모음ViewModel : 조립ViewModelBase
{
    public 주문자Api기능모음ViewModel(
        ...
        음식점탐색PageViewModel 음식점탐색,
        주문자음식주문PageViewModel 음식주문내역,
        ...
        공통Controller기능모음ViewModel 공통Controllers)
    {
        ...
        this.음식주문내역 = 하위ViewModel등록(음식주문내역);
    ...
    public 음식점탐색PageViewModel 음식점탐색 { get; }
    public 주문자음식주문PageViewModel 음식주문내역 { get; }
