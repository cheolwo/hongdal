...
namespace HumanResourcesManagerApp.Services.Security;

public sealed class HumanResourcesMauiSecureTokenStore : IClientSecureTokenStore
{
    private const string StorageKey = "ssalddel.human-resources.authToken.v1";
