namespace 살뜰.도메인.공통
{
    ...
    {
        public static class 배차업무유형
        {
            public const int 음식배달 = 10;
            public const int 용달운송 = 20;
        }

        public static class 배차큐단계
        {
            public const int 계획배차 = 10;
            public const int 배차추천 = 20;
            public const int 공개배차 = 30;
            public const int 확정 = 90;
            public const int 종료 = 99;
        }

        public static class 배차노출상태
        {
            public const int 계획대기 = 100;
            public const int 계획시도중 = 110;
            public const int 계획실패 = 120;
            public const int 추천대기 = 200;
            public const int 추천중 = 210;
            public const int 추천만료 = 220;
            public const int 추천거절 = 230;
            public const int 추천후보없음 = 240;
            public const int 공개대기 = 300;
            public const int 공개중 = 310;
            public const int 확정 = 900;
            public const int 종료 = 990;
        }
