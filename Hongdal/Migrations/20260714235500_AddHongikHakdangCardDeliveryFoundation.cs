...
public sealed class AddHongikHakdangCardDeliveryFoundation : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            name: "hongdal_mobile_push_installations",
            columns: table => new
            {
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_hongdal_mobile_push_installations", x => x.Id);
            })
            .Annotation("MySql:CharSet", "utf8mb4");
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    ...
                    principalTable: "hongdal_mobile_push_installations",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Restrict);
            })
            .Annotation("MySql:CharSet", "utf8mb4");
        ...
        migrationBuilder.CreateIndex(
            ...
            table: "hongdal_mobile_push_installations",
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropTable(name: "hongdal_mobile_push_installations");
    }
}
