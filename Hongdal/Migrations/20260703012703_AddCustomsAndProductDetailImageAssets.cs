    ...
    public partial class AddCustomsAndProductDetailImageAssets : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_홍달참여자", x => x.id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_홍달참여자역할", x => x.id);
                    table.ForeignKey(
                        name: "FK_홍달참여자역할_홍달참여자_참여자_id",
                        column: x => x.참여자_id,
                        principalTable: "홍달참여자",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_홍달참여자역할_참여자_id_역할유형_활성화여부",
                table: "홍달참여자역할",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_홍달_혜택정책", x => x.id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_홍달_오프라인모임", x => x.id);
                    table.ForeignKey(
                        name: "FK_홍달_오프라인모임_홍달_혜택정책_benefit_policy_id",
                        column: x => x.benefit_policy_id,
                        principalTable: "홍달_혜택정책",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_홍달_혜택자격", x => x.id);
                    table.ForeignKey(
                        name: "FK_홍달_혜택자격_홍달_혜택정책_benefit_policy_id",
                        column: x => x.benefit_policy_id,
                        principalTable: "홍달_혜택정책",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_홍달_모임참석", x => x.id);
                    table.ForeignKey(
                        name: "FK_홍달_모임참석_홍달_오프라인모임_meeting_id",
                        column: x => x.meeting_id,
                        principalTable: "홍달_오프라인모임",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_홍달_모임참석_meeting_id_user_id",
                table: "홍달_모임참석",
                columns: new[] { "meeting_id", "user_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_홍달_모임참석_user_id_attendance_status_confirmed_at",
                table: "홍달_모임참석",
                columns: new[] { "user_id", "attendance_status", "confirmed_at" });

            migrationBuilder.CreateIndex(
                name: "IX_홍달_오프라인모임_benefit_policy_id",
                table: "홍달_오프라인모임",
                column: "benefit_policy_id");

            migrationBuilder.CreateIndex(
                name: "IX_홍달_오프라인모임_status_is_active_start_at_end_at",
                table: "홍달_오프라인모임",
                columns: new[] { "status", "is_active", "start_at", "end_at" });

            migrationBuilder.CreateIndex(
                name: "IX_홍달_혜택자격_benefit_policy_id",
                table: "홍달_혜택자격",
                column: "benefit_policy_id");

            migrationBuilder.CreateIndex(
                name: "IX_홍달_혜택자격_user_id_is_active_expires_at",
                table: "홍달_혜택자격",
                columns: new[] { "user_id", "is_active", "expires_at" });

            migrationBuilder.CreateIndex(
                name: "IX_홍달_혜택자격_user_id_source_type_source_id",
                table: "홍달_혜택자격",
                columns: new[] { "user_id", "source_type", "source_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_홍달_혜택정책_source_type_target_type_is_active",
                table: "홍달_혜택정책",
                columns: new[] { "source_type", "target_type", "is_active" });

            migrationBuilder.CreateIndex(
                name: "IX_홍달_혜택정책_start_at_end_at",
                table: "홍달_혜택정책",
