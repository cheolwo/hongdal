...
[HongdalUseCase("Kie AI 이미지 콜백", Summary = "외부 이미지 생성 콜백을 받아 샘플 이미지 작업 결과를 후처리합니다.")]
...
public sealed class KieAi콜백UseCase : IKieAi콜백UseCase
{
    ...
    public KieAi콜백UseCase(HongdalContext db, I샘플이미지생성Service sampleImageGenerationService)
    {
        _db = db;
