...
public sealed class CommandProcessingRule
{
    ...
    public bool? WorkRelationshipSnapshotEnabled { get; set; }
    ...
    public CommandProcessingRule Merge(CommandProcessingRule? overrideRule)
    {
        ...
        return new CommandProcessingRule
        {
            ...
            WorkRelationshipSnapshotEnabled = overrideRule.WorkRelationshipSnapshotEnabled ?? WorkRelationshipSnapshotEnabled,
    ...
    private static CommandProcessingRule Clone(CommandProcessingRule source)
    {
        return new CommandProcessingRule
        {
            ...
            WorkRelationshipSnapshotEnabled = source.WorkRelationshipSnapshotEnabled,
