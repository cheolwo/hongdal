...
public sealed class 주문자집단배송권조회Service : I주문자집단배송권조회Service
{
    public PublicDataLookupResponse<주문자집단배송권후보항목> 후보검색(
        주문자집단배송권조회요청 request)
    {
        ...
        {
            return new PublicDataLookupResponse<주문자집단배송권후보항목>
            {
                Success = false,
    ...
    private static IEnumerable<주문자집단배송권후보항목> BuildCandidates(AddressParts parts)
    {
        yield return new 주문자집단배송권후보항목
        {
    ...
    private static AddressParts? ResolveAddressParts(주문자집단배송권조회요청 request)
    {
