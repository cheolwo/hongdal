...
[MetaData("android.appwidget.provider", Resource = "@xml/ssalddel_widget_info")]
public sealed class 살뜰위젯Provider : AppWidgetProvider
{
    public override void OnUpdate(Context? context, AppWidgetManager? appWidgetManager, int[]? appWidgetIds)
    {
        ...
        var layoutId = resources.GetIdentifier("ssalddel_widget", "layout", packageName);
        ...
        foreach (var appWidgetId in appWidgetIds)
        {
            ...
            var 저장소 = context.GetSharedPreferences("ssalddel_widget", FileCreationMode.Private);
