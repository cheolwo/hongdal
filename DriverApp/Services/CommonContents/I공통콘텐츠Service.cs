...
{
    Task<홍달위젯콘텐츠Dto?> 위젯콘텐츠조회Async(string 위치, CancellationToken cancellationToken = default);
    ...
    Task<홍달위젯콘텐츠Dto?> 위젯콘텐츠동기화Async(string 위치, CancellationToken cancellationToken = default);
}