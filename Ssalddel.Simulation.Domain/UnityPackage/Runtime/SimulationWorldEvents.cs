...
namespace Ssalddel.Simulation.Domain
{
    public sealed partial class 경영SimulationSessionAggregate
    {
        ...
        private bool worldStateAdvanceInProgress;

        private long WorldEventMutationRevision
            => worldStateAdvanceInProgress ? Revision + 1L : Revision;
            ...
            SimulationSurvivalTarotOpportunitySnapshot opportunity)
        {
            ...
            worldEvents.Add(new SimulationWorldEventSnapshot
            {
                ...
                EventRevision = 1,
                LastChangedWorldRevision = WorldEventMutationRevision,
            ...
            SimulationSurvivalTarotOpportunitySnapshot opportunity)
        {
            ...
            value.EventRevision++;
            value.LastChangedWorldRevision = WorldEventMutationRevision;
            ...
            SimulationWorldEventChoiceSnapshot[]? choices = null)
        {
            ...
            worldEvent.LastChangedWorldRevision = WorldEventMutationRevision;
