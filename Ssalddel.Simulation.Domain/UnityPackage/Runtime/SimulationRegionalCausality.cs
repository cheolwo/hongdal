...
namespace Ssalddel.Simulation.Domain
{
    public sealed partial class 경영SimulationSessionAggregate
    {
        ...
        {
            if (threat > recovery) return SimulationRegionalCausalityCodes.ThreatOutcome;
            if (recovery >= threat + 2) return SimulationRegionalCausalityCodes.RecoveryOutcome;
            if (recovery > threat) return SimulationRegionalCausalityCodes.OpportunityOutcome;
            return SimulationRegionalCausalityCodes.NormalOutcome;
        }
