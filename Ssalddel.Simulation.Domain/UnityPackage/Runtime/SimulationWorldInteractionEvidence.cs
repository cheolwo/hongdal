...
namespace Ssalddel.Simulation.Domain
{
    public sealed partial class 경영SimulationSessionAggregate
    {
        ...
        public T ExecuteWorldInteraction<T>(
            SimulationWorldInteractionInvocationRecord invocation,
            Func<T> authorityConfirm,
            Func<long, long, SimulationWorldInteractionManifestationRecord>
                manifestationFactory)
        {
            ...
            if (manifestationFactory == null)
                throw new ArgumentNullException(nameof(manifestationFactory));
            ...
            lock (gate)
            {
                ...
                var manifestation = manifestationFactory(beforeRevision, Revision)
                    ?? throw new SimulationConflictException(
