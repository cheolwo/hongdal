...
namespace Ssalddel.Infrastructure.Persistence.AgriculturalFisheries.Migrations
{
    ...
    [Migration("20260821002918_AddNongsaroPotatoProfileArchive")]
    partial class AddNongsaroPotatoProfileArchive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.KamisPriceObservation", b =>
                {
                    ...
                    b.Property<string>("ComparisonUnit")
                        .IsRequired()
                        .HasMaxLength(50)
                    ...
                    b.Property<string>("PriceNormalizationBasis")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)");

                    b.Property<string>("PriceNormalizationCode")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.Nongsaro감자ProfileArchive", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("ApprovedForSimulationContext")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<string>("DisasterPreventionHashSha256")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");

                    b.Property<DateTime>("DisasterPreventionRetrievedAtUtc")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("ProductRelationStatusCode")
                        .IsRequired()
                        .HasMaxLength(40)
                        .HasColumnType("varchar(40)");
                    ...
                    b.Property<string>("SourceSetHashSha256")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
                    ...
                    b.Property<string>("WorkScheduleContentNo")
                        .IsRequired()
                        .HasMaxLength(40)
                        .HasColumnType("varchar(40)");

                    b.Property<string>("WorkScheduleGroupCode")
                        .IsRequired()
                        .HasMaxLength(40)
                        .HasColumnType("varchar(40)");
                    ...
                    b.HasIndex("StableId", "Revision")
                        .IsUnique();

                    b.HasIndex("CanonicalProductStableId", "ApprovedForSimulationContext", "RetrievedAtUtc");

                    b.ToTable("agri_nongsaro_potato_profiles", (string)null);
                });
            ...
            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.UsdaAms시장가격관측", b =>
                {
                    ...
                    b.HasIndex("ReportBeginDate", "Commodity", "MarketLocationName");

                    b.HasIndex("MarketType", "SourceKey", "District", "ReportBeginDate", "ReportEndDate")
                        .HasDatabaseName("IX_agri_ams_map_shipping_lookup");

                    b.HasIndex("SourceKey", "MarketLocationState", "MarketLocationName", "MarketType", "ReportBeginDate", "ReportEndDate")
            ...
            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.공통식품품목Code관계", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ProductIdentityId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("RelationStatusCode")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)");
                    ...
                    b.ToTable("agri_common_food_product_code_relations", (string)null);

                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CodeScheme = "KAMIS_ITEM",
                            CreatedAtUtc = new DateTime(2026, 8, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            EvidenceNote = "KAMIS 식량작물 100의 품목코드 152로 저장·조회되는 관계입니다.",
                            ExternalCode = "152",
                            IsActive = true,
                            Label = "감자",
                            MatchQualityCode = "SourceCodeConfirmed",
                            ParentCode = "100",
                            ProductIdentityId = 1L,
                            RelationStableId = "relation:product:potato:kamis",
                        ...
                        new
                        {
                            ...
                            CodeScheme = "HS4",
                            CreatedAtUtc = new DateTime(2026, 8, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            EvidenceNote = "국제 HS 4단위 후보이며 종자용 여부·가공도·용도에 따라 국가 세번이 달라질 수 있습니다.",
                            ExternalCode = "0701",
                            IsActive = true,
                            Label = "감자",
                            MatchQualityCode = "ExactCommodityCandidate",
                            ProductIdentityId = 1L,
                            RelationStableId = "relation:product:potato:hs4",
                            RelationStatusCode = "Candidate",
                            Revision = 1,
                            SourceKey = "wco-hs",
                            UpdatedAtUtc = new DateTime(2026, 8, 10, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        ...
                        {
                            Id = 3L,
                            CodeScheme = "USDA_AMS_COMMODITY",
                            CreatedAtUtc = new DateTime(2026, 8, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            EvidenceNote = "식용 감자 공통 품목 후보이며 종서용 감자와 품종·등급·시장 단계는 별도로 검토합니다.",
                            ExternalCode = "Potatoes",
                            IsActive = true,
                            Label = "Potatoes",
                            MatchQualityCode = "DirectCommodityCandidate",
                            ProductIdentityId = 1L,
                            RelationStableId = "relation:product:potato:usda-ams",
                            RelationStatusCode = "Candidate",
                            Revision = 1,
                        ...
                        {
                            Id = 4L,
                            CodeScheme = "NONGSARO_KIND_OF_COMMODITY",
                            CreatedAtUtc = new DateTime(2026, 8, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            EvidenceNote = "농사로 공식 품목구분Code를 현재 근거에서 확인하지 못해 이름으로 연결하지 않습니다.",
                            IsActive = true,
                            Label = "농사로 감자 품목구분",
                            MatchQualityCode = "OfficialCodeRequired",
                            ProductIdentityId = 1L,
                            RelationStableId = "relation:product:potato:nongsaro",
                            RelationStatusCode = "Unlinked",
                            Revision = 1,
                            SourceKey = "nongsaro:farm-working-plan-new",
                            UpdatedAtUtc = new DateTime(2026, 8, 10, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });

            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.공통식품품목Code관계검토이력", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("CodeRelationId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ReviewActionCode")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
                    ...
                    b.Property<string>("ReviewedBySubjectId")
                        .IsRequired()
                        .HasMaxLength(120)
                        .HasColumnType("varchar(120)");
                    ...
                    b.HasIndex("CodeRelationId", "Revision")
                        .IsUnique();

                    b.ToTable("agri_common_food_product_code_relation_reviews", (string)null);
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReviewReason = "공식 source code 초기 등록",
                            ReviewedAtUtc = new DateTime(2026, 8, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            ...
                            RelationStatusCode = "Candidate",
                            ReviewActionCode = "Initialized",
                            ReviewReason = "USDA AMS Commodity 후보 초기 등록",
                            ReviewedAtUtc = new DateTime(2026, 8, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            ReviewedBySubjectId = "system-seed",
                            Revision = 1
                        },
                        new
                        {
                            ...
                            RelationStatusCode = "Unlinked",
                            ReviewActionCode = "Initialized",
                            ReviewReason = "공식 농사로 품목구분Code 확인 전 미연결 등록",
                            ReviewedAtUtc = new DateTime(2026, 8, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            ReviewedBySubjectId = "system-seed",
                            Revision = 1
                        });
            ...
            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.공통식품품목Identity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CanonicalProductStableId")
                        .IsUnique();

                    b.HasIndex("IsActive", "DisplayName");

                    b.ToTable("agri_common_food_product_identities", (string)null);
            ...
            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.공통식품품목Code관계", b =>
                {
                    b.HasOne("Ssalddel.Domain.AgriculturalFisheries.공통식품품목Identity", "ProductIdentity")
                        .WithMany("CodeRelations")
            ...
            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.공통식품품목Code관계검토이력", b =>
                {
                    b.HasOne("Ssalddel.Domain.AgriculturalFisheries.공통식품품목Code관계", "CodeRelation")
                        .WithMany("ReviewHistory")
                        .HasForeignKey("CodeRelationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CodeRelation");
                });
