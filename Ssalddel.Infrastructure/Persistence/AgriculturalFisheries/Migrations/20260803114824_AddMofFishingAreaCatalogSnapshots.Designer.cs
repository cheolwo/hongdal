...
namespace Ssalddel.Infrastructure.Persistence.AgriculturalFisheries.Migrations
{
    ...
    [Migration("20260803114824_AddMofFishingAreaCatalogSnapshots")]
    partial class AddMofFishingAreaCatalogSnapshots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.Mof어획구역Catalog수집Run", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SourceKey", "StatusCode", "CompletedAtUtc");

                    b.ToTable("agri_mof_fishing_area_collection_runs", (string)null);
                });

            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.Mof어획구역Catalog영속Snapshot", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("FreshnessCode")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)");
                    ...
                    b.Property<int>("NormalizedRecordCount")
                        .HasColumnType("int");

                    b.Property<string>("NormalizedRecordsJson")
                        .IsRequired()
                    ...
                    b.HasIndex("SourceKey", "LastSeenAtUtc");

                    b.HasIndex("SourceKey", "DatasetVersion", "ContentSha256")
                        .IsUnique();

                    b.ToTable("agri_mof_fishing_area_snapshots", (string)null);
                });
            ...
            modelBuilder.Entity("Ssalddel.Domain.AgriculturalFisheries.Mof어획구역Catalog수집Run", b =>
                {
                    b.HasOne("Ssalddel.Domain.AgriculturalFisheries.Mof어획구역Catalog영속Snapshot", "Snapshot")
