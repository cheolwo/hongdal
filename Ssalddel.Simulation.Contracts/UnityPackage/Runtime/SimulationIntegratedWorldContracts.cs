...
namespace Ssalddel.Simulation.Contracts
{
    ...
    public static class SimulationIntegratedItemCodes
    {
        ...
        public const string FarmSapling = "FarmSapling";
    ...
    public sealed class SimulationIntegratedWorldInitialStateRequest
    {
        ...
        public SimulationConstructionPlacementZoneRequest[] ConstructionPlacementZones { get; set; }
            = Array.Empty<SimulationConstructionPlacementZoneRequest>();
    }
    ...
    public sealed class SimulationFacilityBlueprintRequest
    {
        ...
        public string[] AllowedPlacementZoneTypeCodes { get; set; } = Array.Empty<string>();
        ...
        public int MaxSlopeMilliDegrees { get; set; }
        public bool RequiresRoadAccess { get; set; }
    }
    ...
    public sealed class SimulationConstructionOrderPayload
    {
        ...
        public string PlacementPreviewHashSha256 { get; set; } = string.Empty;
