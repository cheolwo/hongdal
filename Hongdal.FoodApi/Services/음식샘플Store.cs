...
using Hongdal.FoodApi.Domain.Orders;
...
public sealed class 음식샘플Store
{
    ...
    public 음식샘플Store()
    {
        _restaurants =
        [
            new 음식점요약응답 { Id = 101, 상호명 = "홍달식당 강서점", 카테고리 = "한식", 주소 = "서울 강서구 화곡동", 위도 = 37.5412m, 경도 = 126.8409m, 거리Km = 0.6m, 평균평점 = 4.6m, 리뷰수 = 184, 주문가능여부 = true },
