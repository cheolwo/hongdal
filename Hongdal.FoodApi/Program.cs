...
using Hongdal.FoodApi.Application.DeliveryTickets.Commands;
using Hongdal.FoodApi.Application.DeliveryTickets.Handlers;
using Hongdal.FoodApi.Application.Orders.Commands;
using Hongdal.FoodApi.Application.Orders.Events;
using Hongdal.FoodApi.Application.Orders.Handlers;
...
builder.Host.UseSerilog((context, services, configuration) =>
{
    configuration
        ...
        .Enrich.WithProperty("Application", "Hongdal.FoodApi")
        .WriteTo.Console()
        .WriteTo.File(
            path: "logs/hongdal-foodapi-.log",
