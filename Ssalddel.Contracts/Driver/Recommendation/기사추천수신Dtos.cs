...
public sealed record 기사추천처리결과(string RequestId, string DecisionCode, string Message);

public sealed class 기사상태갱신요청
{
