...
public static class RegionalCultureSpecialtyCatalog
{
    ...
    [
        new(
            ...
            [
                new("랍스터", "수산물", "어획 시기·규격·가공 형태와 냉장·냉동 조건을 함께 확인합니다."),
                new("야생 블루베리", "농산물", "재배종과 구분하고 수확 시기·가공 형태를 확인합니다.")
            ],
        ...
        new(
            ...
            [
                new("복숭아", "농산물", "품종·수확 시기·생과 또는 가공 형태를 구분합니다."),
                new("피칸", "견과", "원물·탈각·가공 제품의 규격과 알레르기 표시를 확인합니다.")
            ],
        ...
        new(
            ...
            [
                new("아몬드", "견과", "산지·수확연도·가공 방식과 물 사용 근거를 함께 살펴봅니다."),
                new("감귤류", "농산물", "품종·수확지·생과 반입과 가공품 조건을 구분합니다."),
                new("포도 가공품", "가공식품", "품종·산지표시·알코올 포함 여부에 따라 별도 검토합니다.")
            ],
        ...
        new(
            ...
            [
                new("사과", "농산물", "도시·현 단위 산지와 품종, 수확 시기를 확인합니다."),
                new("땅콩", "농산물", "원물·기름·가공품을 구분하고 알레르기 표시를 확인합니다."),
                new("마늘", "농산물", "신선·건조·분말 형태와 검역 조건을 구분합니다."),
                new("연안 수산물", "수산물", "어종·어획 또는 양식·가공업소 소재지를 따로 확인합니다.")
            ],
        ...
        new(
            ...
            [
                new("사과·배", "농산물", "현재 성·시·현과 품종, 실제 재배지를 확인합니다."),
                new("해산물", "수산물", "어종·양식 여부·가공 장소와 원산지를 구분합니다."),
                new("인삼 가공품", "가공식품", "식물 종·재배지·가공 성분과 국내 반입 기준을 확인합니다.")
            ],
        ...
        new(
            ...
            [
                new("차", "농산·가공품", "산지·품종·제다 방식·수확 시기와 지리적 표시를 확인합니다."),
                new("쌀 가공품", "가공식품", "지역 조리법과 원재료 산지·첨가물 표시를 구분합니다."),
                new("대나무 가공품", "생활·식품", "식용·생활용을 구분하고 재질·가공·검역 조건을 확인합니다."),
                new("담수 수산물", "수산물", "어종·양식지·가공업소와 식품안전 근거를 각각 확인합니다.")
            ],
