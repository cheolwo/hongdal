...
public sealed class 공동수입준비주문자조회응답
{
    ...
    public IReadOnlyList<공동수입준비주문자재료집계응답> 재료집계목록 { get; set; } = [];
    public 공동수입준비주문자진행상태응답 준비현황 { get; set; } = new();
    public IReadOnlyList<공동수입준비주문자공급자근거응답> 공급자근거목록 { get; set; } = [];
    public IReadOnlyList<공동수입준비주문자견적근거응답> 견적목록 { get; set; } = [];
    public IReadOnlyList<공동수입준비주문자예상비용응답> 예상비용목록 { get; set; } = [];
    public IReadOnlyList<공동수입준비주문자품목분류응답> 품목분류목록 { get; set; } = [];
    public IReadOnlyList<공동수입준비주문자국가별검토응답> 국가별검토목록 { get; set; } = [];
    public 공동수입준비주문자포워더인계응답 포워더인계 { get; set; } = new();
    public 공동수입준비주문자국제운송응답 국제운송검토 { get; set; } = new();
}

public sealed class 공동수입준비주문자재료집계응답
{
...
public sealed class 공동수입준비주문자진행상태응답
{
...
public sealed class 공동수입준비주문자공급자근거응답
{
...
public sealed class 공동수입준비주문자견적근거응답
{
    public string 재료명 { get; set; } = string.Empty;
...
public sealed class 공동수입준비주문자예상비용응답
{
    public string 재료명 { get; set; } = string.Empty;
...
public sealed class 공동수입준비주문자품목분류응답
{
    public string 재료명 { get; set; } = string.Empty;
...
public sealed class 공동수입준비주문자국가별검토응답
{
    public string 관할국가코드 { get; set; } = string.Empty;
    public string 표시명 { get; set; } = string.Empty;
...
public sealed class 공동수입준비주문자포워더인계응답
{
...
public sealed class 공동수입준비주문자국제운송응답
{
