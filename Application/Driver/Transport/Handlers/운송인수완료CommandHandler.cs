...
public sealed class 운송인수완료CommandHandler : IRequestHandler<운송인수완료Command, 기사운송상태변경응답>
{
    private readonly HongdalContext _db;
    private readonly ILogger<운송인수완료CommandHandler> _logger;

    public 운송인수완료CommandHandler(HongdalContext db, ILogger<운송인수완료CommandHandler> logger)
    {
        _db = db;
        _logger = logger;
    }

    public async Task<기사운송상태변경응답> Handle(운송인수완료Command request, CancellationToken cancellationToken)
    {
