...
public sealed class InMemoryShipperStore
{
    ...
    private readonly List<Ssalddel.Contracts.Shipper.Request.공개화물요약응답> _publicCargo = new()
    {
        new Ssalddel.Contracts.Shipper.Request.공개화물요약응답
        {
            의뢰Id = "SHP-1001",
            화물종류 = "가구",
            운송방식 = "일반운송",
    ...
    public IReadOnlyList<Ssalddel.Contracts.Shipper.Request.공개화물요약응답> GetPublicCargo() => _publicCargo.OrderByDescending(x => x.생성일시).ToList();
    ...
    public void AddRequest(ShipperRequestItem request)
    {
        ...
        _publicCargo.Insert(0, new Ssalddel.Contracts.Shipper.Request.공개화물요약응답
        {
            의뢰Id = request.의뢰Id,
            화물종류 = request.화물종류,
            운송방식 = request.운송방식,
