...
public sealed record SsalddelClientNavigationItem(
    string DisplayName,
    string Route,
    string IconKey,
    string GroupKey,
...
public static class SsalddelClientNavigationCatalog
{
    public static readonly IReadOnlyList<SsalddelClientNavigationItem> WarehouseManagerItems =
    [
        ...
        new("판매 주문 원장", ShipperRoutes.SalesOrders, "outbox", "sales", 60),
