...
public sealed class SsalddelAppPlatformHomeWorkspaceNavigationResolver
    : IPlatformHomeWorkspaceNavigationResolver
{
    public string? ResolveEntryHref(PlatformHomeWorkspaceProfile workspace)
    {
        ...
        return workspace.LedgerTemplateKey switch
        {
            ...
            CommunityLedgerTemplateKeys.WarehouseOutbound => ShipperRoutes.WarehouseOutboundWorkStart,
            CommunityLedgerTemplateKeys.WarehouseInbound => ShipperRoutes.WarehouseInboundWorkStart,
