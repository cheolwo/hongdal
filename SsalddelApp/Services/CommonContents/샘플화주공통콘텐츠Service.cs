...
{
    public Task<살뜰위젯콘텐츠Dto?> 혜택콘텐츠조회Async(CancellationToken cancellationToken = default)
    {
        cancellationToken.ThrowIfCancellationRequested();

        return Task.FromResult<살뜰위젯콘텐츠Dto?>(new 살뜰위젯콘텐츠Dto
        {
            콘텐츠Id = 101,
            제목 = "결제 전 혜택 콘텐츠",
    ...
    public Task<살뜰위젯콘텐츠Dto?> 공지콘텐츠조회Async(CancellationToken cancellationToken = default)
    {
        cancellationToken.ThrowIfCancellationRequested();
