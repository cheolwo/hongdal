...
public sealed class CommunityKeywordNotificationModelTests
{
    ...
    private static void AssertTable<TEntity>(SsalddelContext context, string tableName)
        where TEntity : class
    ...
    private static SsalddelContext CreateContext()
    {
        var options = new DbContextOptionsBuilder<SsalddelContext>()
            .UseMySql(
                "Server=localhost;Database=ssalddel_keyword_model_test;User=root;Password=test;",
