...
public sealed class 노드스티커CatalogTests
{
    ...
    [InlineData(CommunityLedgerTemplateKeys.SsalddelMart, "warehouse", "도심 재고", "창고", "basic-warehouse")]
    ...
    private static 노드스티커상점상품Response 상점상품생성(
        ...
        => new()
        {
            상품Key = "store-ssalddel-basic-work-node-stickers",
            팩Key = "ssalddel-basic-work-node-stickers",
            제목 = "살뜰 기본 업무 노드 스티커",
            창작자표시명 = "Ssalddel",
