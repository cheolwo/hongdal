...
public sealed class AdminPageCatalogPageViewModelTests
{
    ...
    public async Task 초기화는_카탈로그와_운영요약을_함께구성한다()
    {
        ...
        [
            Page("admin-home", "admin", "Ssalddel Admin", "admin", "관리", "관리 홈",
            ...
            Page("community-home", "web", "Ssalddel Web", "community", "커뮤니티", "커뮤니티 홈",
    ...
    {
        var client = new RecordingClient([Page("community-home", "web", "Ssalddel Web", "community", "커뮤니티", "커뮤니티 홈")]);
        using var viewModel = CreateViewModel(client);
        await viewModel.초기화Async();
