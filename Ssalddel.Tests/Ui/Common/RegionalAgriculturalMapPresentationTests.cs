...
public sealed class RegionalAgriculturalMapPresentationTests
{
    ...
    public void Web과Maui는_같은한국미국지역지도Workspace를사용한다()
    {
        ...
        var marineStyles = Read(
            "Ssalddel.Ui.Common",
            "Areas",
            "App",
            "Components",
            "Information",
            "MarineFishingAreaOceanMapLayer.razor.css");
