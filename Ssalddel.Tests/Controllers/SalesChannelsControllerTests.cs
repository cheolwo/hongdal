...
public sealed class SalesChannelsControllerTests
{
    [Fact]
    public void Controller는_운영사용자정책으로보호된다()
    {
        var type = typeof(SalesChannelsController);
    ...
    {
        var method = typeof(SalesChannelsController).GetMethod(nameof(SalesChannelsController.계정상세));
    ...
    {
        var method = typeof(SalesChannelsController).GetMethod(nameof(SalesChannelsController.주문출고후보상세));
