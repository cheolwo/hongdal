namespace Hongdal.Contracts.CommonContents;

public enum 계약홍달콘텐츠유형
{
    이미지 = 1,
    영상링크 = 2,
    외부링크 = 3
...
public sealed class 홍달위젯콘텐츠Dto
{
